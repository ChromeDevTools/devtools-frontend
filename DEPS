...
vars = {
  ...
  'build_revision': 'd10dc3f6ad69e7a7b91f62eac101dff88b8657bd',

  'buildtools_url': 'https://chromium.googlesource.com/chromium/src/buildtools.git',
  'buildtools_revision': '64e87f9fbdaf6f53f6cff8f15e4b06f17cead514',

  'depot_tools_url': 'https://chromium.googlesource.com/chromium/tools/depot_tools.git',
  'depot_tools_revision': '56b8271b3f10e046bffac2cfc44b2f81162cd97e',

  'inspector_protocol_url': 'https://chromium.googlesource.com/deps/inspector_protocol',
  'inspector_protocol_revision': 'b8141806c6b0382b0b741d5c23d45c85168644e6',

  # Keeping track of the last time we rolled the browser protocol files.
  'chromium_browser_protocol_revision' : 'd4131488cec036cb5a8b1c69a9c252d54b540f29',
...
deps = {
  ...
  'third_party/chrome/chrome-win': {
    ...
    'objects': [
      {
        'object_name': '156.0.8073.0/win64/chrome-win64.zip',
        'sha256sum': '1d3d876b8c78b57550a61d473a8d7e2dd2717dd7c8784de5f659f543182e7d73',
        'size_bytes': 208841434,
        'generation': 1790266907155979,
      },
    ],
  },
  'third_party/chrome/chrome-mac-x64': {
    ...
    'objects': [
      {
        'object_name': '156.0.8073.0/mac-x64/chrome-mac-x64.zip',
        'sha256sum': 'e13e31a8003caa0ba3d2089907d9aa4b822d7888c2c03729ea6666e6b8ba837a',
        'size_bytes': 205044476,
        'generation': 1790275017497473,
      },
    ],
  },
  'third_party/chrome/chrome-mac-arm64': {
    ...
    'objects': [
      {
        'object_name': '156.0.8073.0/mac-arm64/chrome-mac-arm64.zip',
        'sha256sum': 'd72aab2291478d5ab10dda088986afb2c462d0b933ce5d7f71cb33c1b417948f',
        'size_bytes': 194582779,
        'generation': 1790266080243171,
      },
    ],
  },
  'third_party/chrome/chrome-linux': {
    ...
    'objects': [
      {
        'object_name': '156.0.8073.0/linux64/chrome-linux64.zip',
        'sha256sum': 'a914018bd745298f0f220b778d98f5962f702548e4fdf3f8aa797787b9401631',
        'size_bytes': 199897302,
        'generation': 1790265025979051,
      },
    ],
  },
