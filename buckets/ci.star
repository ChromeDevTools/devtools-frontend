...
generate_ci_configs(
    ...
    builders = [
        builder_descriptor(
            ...
            excluded_from = ["beta", "stable", "extended", "parallel"],
            execution_timeout = 2 * time.hour,
        ),
        builder_descriptor(
            name = "DevTools Linux Fastbuild",
            recipe_name = "chromium_integration",
            excluded_from = ["beta", "stable", "extended", "chromium", "parallel"],
            execution_timeout = 2 * time.hour,
            description_html = """
...
DevTools Linux</a> but has devtools_skip_typecheck=True.""",
        ...
        builder_descriptor(
            ...
            excluded_from = ["chromium", "parallel"],
        ),
        builder_descriptor(
            name = "Stand-alone Parallel Linux",
            recipe_name = "devtools/devtools-frontend",
            excluded_from = ["chromium", "ci"],
        ),
        builder_descriptor(
...
Linux Compile Debug</a> but has devtools_skip_typecheck=True.""",
        ...
        builder_descriptor(
            ...
            recipe_name = "devtools/devtools-frontend",
            excluded_from = ["chromium", "beta", "stable", "extended", "parallel"],
        ...
        builder_descriptor(
            ...
            recipe_name = "devtools/devtools-frontend",
            dims = dimensions.mac,
            excluded_from = ["chromium", "beta", "stable", "extended", "ci"],
        ),
        builder_descriptor(
            name = "Linux Official",
            recipe_name = "devtools/devtools-frontend",
