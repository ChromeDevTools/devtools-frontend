  ...
  setNode: function(node) {
    ...
    for (var i = 0; i < attributes.length; ++i) {
      ...
      if (WebInspector.ARIAAttributesPane._attributes.indexOf(attribute.name) < 0)
        continue;
      this._treeOutline.appendChild(
          new WebInspector.ARIAAttributesTreeElement(this, attribute, target));
    }
...
WebInspector.ARIAAttributesTreeElement.prototype = {
  ...
  _startEditing: function() {
    ...
    proxyElement.addEventListener(
        'keydown', this._editingValueKeyDown.bind(this, previousContent), false);
