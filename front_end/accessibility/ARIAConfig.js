WebInspector.ARIAMetadata._config = {
  'attributes': {
    ...
    'aria-autocomplete':
        {'default': 'none', 'enum': ['inline', 'list', 'both', 'none'], 'type': 'token'},
    'aria-busy': {'default': 'false', 'type': 'boolean'},
    'aria-checked':
        {'default': 'undefined', 'enum': ['true', 'false', 'mixed', 'undefined'], 'type': 'token'},
    ...
    'aria-expanded':
        {'default': 'undefined', 'enum': ['true', 'false', 'undefined'], 'type': 'token'},
    ...
    'aria-invalid':
        {'default': 'false', 'enum': ['grammar', 'false', 'spelling', 'true'], 'type': 'token'},
    ...
    'aria-orientation':
        {'default': 'vertical', 'enum': ['horizontal', 'vertical'], 'type': 'token'},
    ...
    'aria-sort':
        {'default': 'none', 'enum': ['ascending', 'descending', 'none', 'other'], 'type': 'token'},
  ...
  'roles': {
    ...
    'select':
        {'abstract': true, 'nameFrom': ['author'], 'superclasses': ['composite', 'group', 'input']},
    'separator': {
      'nameFrom': ['author'],
      'superclasses': ['structure'],
