...
WebInspector.AXNodeSubPane = function() {
  ...
  this._ignoredInfo = this.createInfo(
      WebInspector.UIString('Accessibility node not exposed'), 'ax-ignored-info hidden');
...
WebInspector.AXNodeSubPane.prototype = {
  ...
  setAXNode: function(axNode) {
    ...
    if (!axNode) {
      ...
      function addIgnoredReason(property) {
        ignoredReasons.appendChild(
            new WebInspector.AXNodeIgnoredReasonTreeElement(property, axNode, target));
      }
      var ignoredReasonsArray =
          /** @type {!Array<!AccessibilityAgent.AXProperty>} */ (axNode.ignoredReasons);
    ...
    var roleProperty =
        /** @type {!AccessibilityAgent.AXProperty} */ ({name: 'role', value: axNode.role});
    addProperty(roleProperty);

    var propertyMap = {};
    var propertiesArray =
        /** @type {!Array.<!AccessibilityAgent.AXProperty>} */ (axNode.properties);
...
WebInspector.AXNodePropertyTreeElement.prototype = {
  ...
  appendValueElement: function(value) {
    ...
    var element = WebInspector.AXNodePropertyTreeElement.createSimpleValueElement(
  ...
  appendRelatedNode: function(relatedNode, index) {
    ...
    var nodeTreeElement =
        new WebInspector.AXRelatedNodeSourceTreeElement({deferredNode: deferredNode}, relatedNode);
  ...
  appendRelatedNodeInline: function(relatedNode) {
    var deferredNode = new WebInspector.DeferredDOMNode(this._target, relatedNode.backendNodeId);
    var linkedNode =
        new WebInspector.AXRelatedNodeElement({deferredNode: deferredNode}, relatedNode);
...
WebInspector.AXValueSourceTreeElement.prototype = {
  ...
  appendRelatedNodeListValueElement: function(value) {
    ...
    if (value.type === AccessibilityAgent.AXValueType.IdrefList ||
      ...
      WebInspector.AXNodePropertyTreeElement.prototype.appendRelatedNodeListValueElement.call(
          this, value);
    }
  ...
  _update: function() {
    ...
    if (this._source.invalid) {
      var exclamationMark = WebInspector.AXNodePropertyTreeElement.createExclamationMark(
  ...
  appendValueElement: function(value) {
    var element =
        WebInspector.AXNodePropertyTreeElement.prototype.appendValueElement.call(this, value);
    if (!element) {
...
/**
 * @constructor
 * @param {{deferredNode: (!WebInspector.DeferredDOMNode|undefined), idref: (string|undefined)}}
 * node
  ...
  render: function() {
    ...
    function onNodeResolved(node) {
      valueElement.appendChild(
          WebInspector.DOMPresentationUtils.linkifyNodeReference(node, this._idref));
    }
    ...
    if (this._deferredNode) {
      ...
      valueElement = WebInspector.AXNodePropertyTreeElement.createExclamationMark(
...
WebInspector.AXNodeIgnoredReasonTreeElement.prototype = {
  ...
  onattach: function() {
    ...
    this._reasonElement = WebInspector.AXNodeIgnoredReasonTreeElement.createReasonElement(
...
WebInspector.AXNodeIgnoredReasonTreeElement.createReasonElement = function(reason, axNode) {
  ...
  switch (reason) {
    case 'activeModalDialog':
      reasonElement =
          WebInspector.formatLocalized('Element is hidden by active modal dialog:\u00a0', []);
      break;
    ...
    case 'ancestorIsLeafNode':
      reasonElement =
          WebInspector.formatLocalized('Ancestor\'s children are all presentational:\u00a0', []);
      break;
    case 'ariaHidden':
    ...
    case 'ariaHiddenRoot':
      ...
      reasonElement =
          WebInspector.formatLocalized('%s is %s on ancestor:\u00a0', [ariaHiddenSpan, trueSpan]);
      break;
    case 'emptyAlt':
    ...
    case 'inheritsPresentation':
      reasonElement =
          WebInspector.formatLocalized('Element inherits presentational role from\u00a0', []);
      break;
    case 'labelContainer':
    ...
    case 'presentationalRole':
      var rolePresentationSpan = createElement('span', 'source-code').textContent =
    ...
    case 'staticTextUsedAsNameFor':
      reasonElement =
          WebInspector.formatLocalized('Static text node is used as name for\u00a0', []);
      break;
    case 'uninteresting':
      reasonElement =
          WebInspector.formatLocalized('Element not interesting for accessibility.', []);
      break;
  }
  if (reasonElement)
