...
WebInspector.AccessibilitySidebarView.prototype = {
  ...
  doUpdate: function() {
    ...
    return WebInspector.AccessibilityModel.fromTarget(node.target())
        .getAXNodeChain(node.id)
  ...
  wasShown: function() {
    ...
    WebInspector.targetManager.addModelListener(
        WebInspector.DOMModel, WebInspector.DOMModel.Events.CharacterDataModified,
        this._onNodeChange, this);
    WebInspector.targetManager.addModelListener(
        WebInspector.DOMModel, WebInspector.DOMModel.Events.ChildNodeCountUpdated,
        this._onNodeChange, this);
  },
