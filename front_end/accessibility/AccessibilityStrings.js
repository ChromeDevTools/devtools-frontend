...
WebInspector.AccessibilityStrings.AXSourceTypes = {
  ...
  'placeholder':
      {name: 'From placeholder attribute', description: 'Value from placeholder attribute.'},
...
WebInspector.AccessibilityStrings.AXNativeSourceTypes = {
  ...
  'labelfor':
      {name: 'From label (for)', description: 'Value from label element with for= attribute.'},
