...
WebInspector.AnimationModel = function(target) {
  ...
  var resourceTreeModel = /** @type {!WebInspector.ResourceTreeModel} */ (
      WebInspector.ResourceTreeModel.fromTarget(target));
  resourceTreeModel.addEventListener(
      WebInspector.ResourceTreeModel.Events.MainFrameNavigated, this._reset, this);
  this._screenshotCapture =
      new WebInspector.AnimationModel.ScreenshotCapture(target, this, resourceTreeModel);
};
...
WebInspector.AnimationModel.prototype = {
   ...
   * @param {string} id
   */
  animationCreated: function(id) { this._pendingAnimations.push(id); },
  ...
  animationStarted: function(payload) {
    ...
    if (animation.type() === 'WebAnimation' &&
        animation.source().keyframesRule().keyframes().length === 0) {
  ...
  _matchExistingGroups: function(incomingGroup) {
    ...
    if (!matchedGroup) {
      ...
      this._screenshotCapture.captureScreenshots(
          incomingGroup.finiteDuration(), incomingGroup._screenshots);
    }
  ...
  _createGroupFromPendingAnimations: function() {
    ...
    return new WebInspector.AnimationModel.AnimationGroup(
        this, groupedAnimations[0].id(), groupedAnimations);
  },
...
WebInspector.AnimationModel.Animation = function(target, payload) {
  ...
  this._source =
      new WebInspector.AnimationModel.AnimationEffect(this.target(), this._payload.source);
};
...
WebInspector.AnimationModel.Animation.prototype = {
  /**
     ...
     */
  payload: function() { return this._payload; },

  /**
     * @return {string}
     */
  id: function() { return this._payload.id; },

  /**
     * @return {string}
     */
  name: function() { return this._payload.name; },

  /**
     * @return {boolean}
     */
  paused: function() { return this._payload.pausedState; },

  /**
     * @return {string}
     */
  playState: function() { return this._playState || this._payload.playState; },

  /**
   * @param {string} playState
   */
  setPlayState: function(playState) { this._playState = playState; },

  /**
     * @return {number}
     */
  playbackRate: function() { return this._payload.playbackRate; },

  /**
     * @return {number}
     */
  startTime: function() { return this._payload.startTime; },
  ...
  endTime: function() {
    ...
    return this.startTime() + this.source().delay() +
        this.source().duration() * this.source().iterations() + this.source().endDelay();
  },
  ...
  /**
     * @return {number}
     */
  currentTime: function() { return this._payload.currentTime; },
  ...
  _updateNodeStyle: function(duration, delay, node) {
    ...
    if (!cssModel)
      return;
    cssModel.setEffectivePropertyValueForNode(
        node.id, animationPrefix + 'duration', duration + 'ms');
  ...
  /**
     * @return {string}
     */
  _cssId: function() { return this._payload.cssId || ''; },
...
WebInspector.AnimationModel.AnimationEffect = function(target, payload) {
  ...
  if (payload.keyframesRule)
    this._keyframesRule =
        new WebInspector.AnimationModel.KeyframesRule(target, payload.keyframesRule);
...
WebInspector.AnimationModel.AnimationEffect.prototype = {
  /**
     * @return {number}
     */
  delay: function() { return this._delay; },

  /**
     * @return {number}
     */
  endDelay: function() { return this._payload.endDelay; },

  /**
     * @return {number}
     */
  iterationStart: function() { return this._payload.iterationStart; },
  ...
  /**
     * @return {string}
     */
  direction: function() { return this._payload.direction; },

  /**
     * @return {string}
     */
  fill: function() { return this._payload.fill; },
  ...
  /**
     * @return {number}
     */
  backendNodeId: function() { return this._payload.backendNodeId; },

  /**
     * @return {?WebInspector.AnimationModel.KeyframesRule}
     */
  keyframesRule: function() { return this._keyframesRule; },

  /**
     * @return {string}
     */
  easing: function() { return this._payload.easing; },
...
WebInspector.AnimationModel.KeyframeStyle.prototype = {
   ...
   * @param {number} offset
   */
  setOffset: function(offset) { this._offset = offset * 100 + '%'; },

  /**
     * @return {number}
     */
  offsetAsNumber: function() { return parseFloat(this._offset) / 100; },
...
WebInspector.AnimationModel.AnimationGroup.prototype = {
  ...
  /**
     ...
     */
  animations: function() { return this._animations; },
  ...
  _animationIds: function() {
    /**
         ...
         * @return {string}
         */
    function extractId(animation) { return animation.id(); }
  ...
  /**
     * @return {number}
     */
  startTime: function() { return this._animations[0].startTime(); },
  ...
  currentTimePromise: function() {
    /**
         ...
         * @return {number}
         */
    function callback(error, currentTime) { return !error ? currentTime : 0; }
    ...
    return this.target()
        .animationAgent()
        .getCurrentTime(longestAnim.id(), callback)
        .catchException(0);
  },
...
WebInspector.AnimationDispatcher.prototype = {
   ...
   * @param {string} id
   */
  animationCreated: function(id) { this._animationModel.animationCreated(id); },

  /**
   * @override
   * @param {string} id
   */
  animationCanceled: function(id) { this._animationModel._animationCanceled(id); },

  /**
   * @override
   * @param {!AnimationAgent.Animation} payload
   */
  animationStarted: function(payload) { this._animationModel.animationStarted(payload); }
};
...
WebInspector.AnimationModel.ScreenshotCapture = function(target, model, resourceTreeModel) {
  ...
  this._model.addEventListener(
      WebInspector.AnimationModel.Events.ModelReset, this._stopScreencast, this);
};
...
WebInspector.AnimationModel.ScreenshotCapture.prototype = {
  ...
  _screencastFrame: function(event) {
    /**
         ...
         * @return {boolean}
         */
    function isAnimating(request) { return request.endTime >= now; }
