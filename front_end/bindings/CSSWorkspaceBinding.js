...
WebInspector.CSSWorkspaceBinding.prototype = {
  ...
  /**
     ...
     */
  _targetInfo: function(header) { return this._modelToTargetInfo.get(header.cssModel()) || null; },
  ...
  propertyUILocation: function(cssProperty, forName) {
    ...
    if (!style || style.type !== WebInspector.CSSStyleDeclaration.Type.Regular ||
        !style.styleSheetId)
      return null;
...
WebInspector.CSSWorkspaceBinding.TargetInfo.prototype = {
   ...
   * @param {!WebInspector.CSSWorkspaceBinding.LiveLocation} location
   */
  _removeLocation: function(location) { this._locations.remove(location._header, location); },
 ...
 * @param {!WebInspector.LiveLocationPool} locationPool
 */
WebInspector.CSSWorkspaceBinding.LiveLocation = function(
    cssModel, header, rawLocation, binding, updateDelegate, locationPool) {
