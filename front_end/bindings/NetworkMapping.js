 ...
 */
WebInspector.NetworkMapping = function(
    targetManager, workspace, fileSystemWorkspaceBinding, fileSystemMapping) {
...
WebInspector.NetworkMapping.prototype = {
  ...
  _networkUISourceCodeForURL: function(target, frame, url) {
    return this._workspace.uiSourceCode(
        WebInspector.NetworkProject.projectId(target, frame, false), url);
  },
  ...
  _contentScriptUISourceCodeForURL: function(target, frame, url) {
    return this._workspace.uiSourceCode(
        WebInspector.NetworkProject.projectId(target, frame, true), url);
  },
  ...
  addMapping: function(networkUISourceCode, uiSourceCode) {
    ...
    this._fileSystemMapping.addMappingForResource(
    ...
    function listener(event) {
      ...
      if (uiSourceCode.url() === url) {
        ...
        this._workspace.removeEventListener(
            WebInspector.Workspace.Events.UISourceCodeAdded, listener, this);
      }
    }
