  ...
  var xmlConfig = {
    ...
    caseFold: false
                  ...
                  CodeMirror.defineMode('xml', function(editorConf, config_) {
                    ...
                    var config = {} var defaults = config_.htmlMode ? htmlConfig : xmlConfig
                    for (var prop in defaults) config[prop] =
                        defaults[prop] for (var prop in config_) config[prop] = config_[prop]
