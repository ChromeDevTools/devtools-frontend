...
(function(mod) {
  ...
  var commonKeywords = [
    ...
    'except', 'finally', 'for',   'from',  'global',   'if',    'import', 'lambda', 'pass',
  ...
  var commonBuiltins = [
    ...
    'type',       'vars',         'zip',         '__import__', 'NotImplemented', 'Ellipsis',
    '__debug__'
  ];
  ...
  CodeMirror.defineMode('python', function(conf, parserConf) {
    ...
    if (py3) {
      ...
      myBuiltins = myBuiltins.concat([
        'apply', 'basestring', 'buffer', 'cmp', 'coerce', 'execfile', 'file', 'intern', 'long',
        'raw_input', 'reduce', 'reload', 'unichr', 'unicode', 'xrange', 'False', 'True', 'None'
      ]);
      ...
      indent: function(state, textAfter) {
        ...
        var scope = top(state), closing = scope.type ==
            textAfter.charAt(0) if (scope.align != null) return scope.align -
                (closing ? 1 : 0) else return scope.offset - (closing ? hangingIndent : 0)
      },
