...
WebInspector.CustomPreviewComponent = function(object) {
  ...
  var shadowRoot = WebInspector.createShadowRootWithCoreStyles(
      this.element, 'components/customPreviewSection.css');
...
WebInspector.CustomPreviewComponent.prototype = {
  ...
  _contextMenuEventFired: function(event) {
    ...
    if (this._customPreviewSection)
      contextMenu.appendItem(
          WebInspector.UIString.capitalize('Show as Javascript ^object'),
          this._disassemble.bind(this));
  ...
  _disassemble: function() {
    ...
    this.element.shadowRoot.appendChild(
        WebInspector.ObjectPropertiesSection.defaultObjectPresentation(this._object));
  }
};

WebInspector.CustomPreviewSection._tagsWhiteList =
...
WebInspector.CustomPreviewSection.prototype = {
  ...
  /**
     * @return {!Element}
     */
  element: function() { return this._sectionElement; },
  ...
  _layoutObjectTag: function(objectTag) {
    ...
    var sectionElement =
        WebInspector.ObjectPropertiesSection.defaultObjectPresentation(remoteObject);
  ...
  _loadBody: function() {
    ...
    function load(bindRemoteObject, formatter, config) {
      ...
      function substituteObjectTagsInCustomPreview(jsonMLObject) {
        if (!jsonMLObject || (typeof jsonMLObject !== 'object') ||
    ...
    var args = [
      {objectId: customPreview.bindRemoteObjectFunctionId},
