...
* ?Array<!WebInspector.EventListener>, frameworkEventListeners: ?{eventListeners:
* ?Array<!WebInspector.EventListener>, internalHandlers: ?WebInspector.RemoteArray}, isInternal:
* ?Array<boolean>}>}
*/
...
WebInspector.EventListenersView.prototype = {
  ...
  _addObject: function(object) {
    ...
    promises.push(WebInspector.EventListener.frameworkEventListeners(object).then(
  ...
  _getOrCreateTreeElementForType: function(type) {
    ...
    if (!treeItem) {
      treeItem =
          new WebInspector.EventListenersTreeElement(type, this._linkifier, this._changeCallback);
...
WebInspector.ObjectEventListenerBar.prototype = {
  ...
  _setTitle: function(object, linkifier) {
    ...
    if (this._eventListener.isScrollBlockingType() && this._eventListener.isNormalListenerType()) {
      ...
      passiveButton.title =
          WebInspector.UIString('Toggle whether event listener is passive or blocking');
