...
export declare enum AnimationsPlaybackRate {
    PERCENT_100 = 0,
    PERCENT_25 = 1,
    PERCENT_10 = 2,
    OTHER = 3,
...
export declare enum TimelineNavigationSetting {
...
export declare enum BuiltInAiAvailability {
...
export declare enum ResendRequestType {
    XHR = 0,
    FETCH = 1,
    SCRIPT = 2,
    STYLESHEET = 3,
