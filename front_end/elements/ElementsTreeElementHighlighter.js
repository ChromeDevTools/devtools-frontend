...
WebInspector.ElementsTreeElementHighlighter = function(treeOutline) {
  ...
  WebInspector.targetManager.addModelListener(
      WebInspector.DOMModel, WebInspector.DOMModel.Events.NodeHighlightedInOverlay,
...
WebInspector.ElementsTreeElementHighlighter.prototype = {
  ...
  _highlightNode: function(event) {
    ...
    this._pendingHighlightNode =
        this._treeOutline.domModel() === domNode.domModel() ? domNode : null;
  ...
  _highlightNodeInternal: function(node) {
    ...
    if (node) {
      ...
      while (deepestExpandedParent && (!deepestExpandedParent[treeElementSymbol] ||
                                       !deepestExpandedParent[treeElementSymbol].expanded))
        deepestExpandedParent = deepestExpandedParent.parentNode;

      this._alreadyExpandedParentElement = deepestExpandedParent ?
          deepestExpandedParent[treeElementSymbol] :
          this._treeOutline.rootElement();
