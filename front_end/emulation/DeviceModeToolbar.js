...
WebInspector.DeviceModeToolbar = function(model, showMediaInspectorSetting, showRulersSetting) {
  ...
  this._showDeviceScaleFactorSetting =
      WebInspector.settings.createSetting('emulation.showDeviceScaleFactor', false);
  ...
  this._showNetworkConditionsSetting =
      WebInspector.settings.createSetting('emulation.showNetworkConditions', false);
  ...
  this._emulatedDevicesList.addEventListener(
      WebInspector.EmulatedDevicesList.Events.StandardDevicesUpdated, this._deviceListChanged,
      this);
...
WebInspector.DeviceModeToolbar.prototype = {
  ...
  _fillLeftToolbar: function(toolbar) {
    ...
    this._deviceSelectItem =
        new WebInspector.ToolbarMenuButton(this._appendDeviceMenuItems.bind(this));
  ...
  _fillMainToolbar: function(toolbar) {
    ...
    this._updateWidthInput = WebInspector.bindInput(
        widthInput, applyWidth.bind(this), WebInspector.DeviceModeModel.deviceSizeValidator, true);
    ...
    this._updateHeightInput =
        WebInspector.bindInput(heightInput, applyHeight.bind(this), validateHeight, true);
  ...
  _fillRightToolbar: function(toolbar) {
    ...
    this._deviceScaleItem =
        new WebInspector.ToolbarMenuButton(this._appendDeviceScaleMenuItems.bind(this));
  ...
  _fillOptionsToolbar: function(toolbar) {
    ...
    var moreOptionsButton =
        new WebInspector.ToolbarMenuButton(this._appendOptionsMenuItems.bind(this));
  ...
  _appendScaleMenuItems: function(contextMenu) {
    ...
    function appendScaleItem(title, value) {
      contextMenu.appendCheckboxItem(
          title, scaleSetting.set.bind(scaleSetting, value), scaleSetting.get() === value, false);
    }
  },
  ...
  _appendUserAgentMenuItems: function(contextMenu) {
    ...
    appendUAItem(
        WebInspector.DeviceModeModel.UA.DesktopTouch, WebInspector.DeviceModeModel.UA.DesktopTouch);
  ...
  _appendOptionsMenuItems: function(contextMenu) {
    ...
    function appendToggleItem(setting, title1, title2, disabled) {
      ...
      contextMenu.appendItem(
          setting.get() ? title1 : title2, setting.set.bind(setting, !setting.get()), disabled);
    }
  },
  ...
  _wrapToolbarItem: function(element) {
    ...
    var shadowRoot =
        WebInspector.createShadowRootWithCoreStyles(container, 'emulation/deviceModeToolbar.css');
  ...
  /**
     * @return {!Array<!WebInspector.EmulatedDevice>}
     */
  _customDevices: function() { return this._filterDevices(this._emulatedDevicesList.custom()); },

  /**
     * @return {!Array<!WebInspector.EmulatedDevice>}
     */
  _allDevices: function() { return this._standardDevices().concat(this._customDevices()); },
  ...
  _appendDeviceMenuItems: function(contextMenu) {
    ...
    function appendGroup(devices) {
      ...
      for (var device of devices)
        contextMenu.appendCheckboxItem(
            device.title, this._emulateDevice.bind(this, device), this._model.device() === device,
            false);
    }
  },
