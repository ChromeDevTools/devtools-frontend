...
WebInspector.InspectedPagePlaceholder.prototype = {
  ...
  _dipPageRect: function() {
    ...
    var bottom =
        Math.min(rect.bottom * zoomFactor - this._margins.bottom, bodyRect.bottom * zoomFactor);
    var right =
        Math.min(rect.right * zoomFactor - this._margins.right, bodyRect.right * zoomFactor);
