...
InspectorFrontendHostAPI.EventDescriptors = [
  ...
  [
    InspectorFrontendHostAPI.Events.DevicesPortForwardingStatusChanged,
  ...
  [
    InspectorFrontendHostAPI.Events.DispatchMessageChunk, 'dispatchMessageChunk',
    ['messageChunk', 'messageSize']
  ],
  [InspectorFrontendHostAPI.Events.EnterInspectElementMode, 'enterInspectElementMode', []],
  [
    InspectorFrontendHostAPI.Events.EvaluateForTestInFrontend, 'evaluateForTestInFrontend',
    ['callId', 'script']
  ],
  ...
  [
    InspectorFrontendHostAPI.Events.FileSystemAdded, 'fileSystemAdded',
  ...
  [
    InspectorFrontendHostAPI.Events.IndexingWorked, 'indexingWorked',
  ...
  [
    InspectorFrontendHostAPI.Events.RevealSourceLine, 'revealSourceLine',
    ['url', 'lineNumber', 'columnNumber']
  ],
  [InspectorFrontendHostAPI.Events.SavedURL, 'savedURL', ['url']],
  [
    InspectorFrontendHostAPI.Events.SearchCompleted, 'searchCompleted',
