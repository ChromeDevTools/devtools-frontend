  ...
  async handler(
    ...
    if (options?.approved !== true) {
      ...
      return {
        ...
        description:
            lockedString(`The AI wants to access the value(s) of ${args.type} keys ${keyString} on ${targetsDesc}.`),
      };
    }

    const storageValuesByOrigin: GetStorageValuesResult['storageValuesByOrigin'] = {};
