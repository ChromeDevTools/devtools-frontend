...
export declare class GetStylesTool implements Tool<GetStylesArgs, unknown, BaseToolCapability & TargetCapability & OriginLockCapability> {
    ...
    handler(params: GetStylesArgs, context: BaseToolCapability & TargetCapability & OriginLockCapability, _options?: FunctionHandlerOptions): Promise<FunctionCallHandlerResult<unknown>>;
}
