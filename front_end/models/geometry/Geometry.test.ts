...
describe('Vector', () => {
  it('can be instantiated without issues', () => {
    const vector = new Geometry.Vector(1, 2, 3);
  ...
  it('does not normalize if the length was below epsilon', () => {
    const vector = new Geometry.Vector(0.000001, 0.000002, 0.000003);
    vector.normalize();
...
describe('Point', () => {
  ...
  it('is able to return distanct to a certain point', () => {
    ...
    const p2 = new Geometry.Point(0, 1);
    const p3 = new Geometry.Point(1, 0);
    const p4 = new Geometry.Point(3, 4);
  ...
  it('is able to be projected on a point that is not the origin', () => {
    const p1 = new Geometry.Point(1, 2);
  ...
  it('is able to be projected on a point that is the origin', () => {
    const p1 = new Geometry.Point(1, 2);
    const p2 = new Geometry.Point(0, 0);
    const projectedPoint = p1.projectOn(p2);
  ...
  it('can be represented as a string', () => {
    const point = new Geometry.Point(1.23, 4.56);
...
describe('CubicBezier', () => {
  it('can be instantiated without issues', () => {
    const p1 = new Geometry.Point(1, 2);
    const p2 = new Geometry.Point(3, 4);
    const cubicBezier = new Geometry.CubicBezier(p1, p2);
  ...
  it('is able to return a cubic bezier from a valid string', () => {
    ...
    const {controlPoints} = Geometry.CubicBezier.parse(testText)!;
  ...
  it('returns null from an invalid string', () => {
    ...
    const cubicBezier = Geometry.CubicBezier.parse(testText);
  ...
  it('is able to be represented as CSS text with a keyword value', () => {
    const p1 = new Geometry.Point(0.25, 0.1);
    const p2 = new Geometry.Point(0.25, 1);
    const cubicBezier = new Geometry.CubicBezier(p1, p2);
    const cssText = cubicBezier.asCSSText();
...
describe('EulerAngles', () => {
  it('can be instantiated without issues', () => {
    const eulerAngles = new Geometry.EulerAngles(1, 2, 3);
  ...
  it('is able to return Euler angles from an identity rotation matrix', () => {
    ...
    const result = Geometry.EulerAngles.fromDeviceOrientationRotationMatrix(matrix);
  ...
  it('is able to return Euler angles from a rotation matrix', () => {
    ...
    result = Geometry.EulerAngles.fromDeviceOrientationRotationMatrix(matrix);
    assert.strictEqual(result.alpha, 0, 'alpha value was not set correctly');
...
describe('Size', () => {
  it('can be instantiated without issues', () => {
    const size = new Geometry.Size(1, 2);
  ...
  it('can be clipped to another smaller size', () => {
    const size1 = new Geometry.Size(3, 4);
    const size2 = new Geometry.Size(1, 2);
  ...
  it('can be clipped to another larger size', () => {
    const size1 = new Geometry.Size(1, 2);
    const size2 = new Geometry.Size(3, 4);
    const resultSize = size1.clipTo(size2);
    assert.strictEqual(resultSize.width, 1, 'width value was not set correctly');
    assert.strictEqual(resultSize.height, 2, 'height value was not set correctly');
  });
  ...
  it('is able to check if it is equal to another size', () => {
    const size1 = new Geometry.Size(1, 2);
    const size2 = new Geometry.Size(3, 4);
    const size3 = new Geometry.Size(1, 2);
...
describe('Constraints', () => {
  it('can be instantiated without issues', () => {
    const size1 = new Geometry.Size(1, 2);
    const size2 = new Geometry.Size(3, 4);
    const constraints = new Geometry.Constraints(size1, size2);
  ...
  it('thows an error if instantiated with a minimum size that is larger than the the preferred size', () => {
    const size1 = new Geometry.Size(3, 4);
    const size2 = new Geometry.Size(1, 2);
    assert.throws(() => new Geometry.Constraints(size1, size2), Error, 'Minimum size is greater than preferred.');
  });

  it('sets minimum and preferred to Geometry.Size(0, 0) if no values were given to the constructor', () => {
    const constraints = new Geometry.Constraints();
  ...
  it('is able to check if it is equal to another constraint', () => {
    const size1 = new Geometry.Size(1, 2);
    const size2 = new Geometry.Size(3, 4);
    const size3 = new Geometry.Size(5, 6);
    const size4 = new Geometry.Size(7, 8);
    const constraints1 = new Geometry.Constraints(size1, size2);
    const constraints2 = new Geometry.Constraints(size3, size4);
    const constraints3 = new Geometry.Constraints(size1, size2);
...
describe('scalarProduct', () => {
  it('returns the scalar product for two vectors', () => {
    const vector1 = new Geometry.Vector(1, 2, 3);
    const vector2 = new Geometry.Vector(4, 5, 6);
    const result = Geometry.scalarProduct(vector1, vector2);
...
describe('crossProduct', () => {
  it('returns the cross product for two vectors', () => {
    const vector1 = new Geometry.Vector(1, 2, 3);
    const vector2 = new Geometry.Vector(4, 5, 6);
    const result = Geometry.crossProduct(vector1, vector2);
...
describe('subtract', () => {
  it('returns the difference between two vectors', () => {
    const vector1 = new Geometry.Vector(1, 2, 3);
    const vector2 = new Geometry.Vector(4, 5, 6);
    const result = Geometry.subtract(vector1, vector2);
    assert.strictEqual(result.x, -3, 'x value for the resulting vector was not set correctly');
...
describe('multiplyVectorByMatrixAndNormalize', () => {
  it('returns the vector multiplied by a matrix and normalized', () => {
    ...
    const result = Geometry.multiplyVectorByMatrixAndNormalize(vector, matrix);
...
describe('calculateAngle', () => {
  it('returns the angle between two vectors', () => {
    const vector1 = new Geometry.Vector(1, 2, 3);
    const vector2 = new Geometry.Vector(4, 5, 6);
    const result = Geometry.calculateAngle(vector1, vector2);
...
describe('boundsForTransformedPoints', () => {
  it('returns the bounds for transformed points', () => {
    const matrix = new WebKitCSSMatrix();
    const result = Geometry.boundsForTransformedPoints(matrix, [1, 2, 3], {minX: 5, maxX: 6, minY: 7, maxY: 8});
  ...
  describe('degreesToRadians', () => {
    it('converts degrees to radians correctly', () => {
      assert.strictEqual(Geometry.degreesToRadians(45), 0.7853981633974483);
      assert.strictEqual(Geometry.degreesToRadians(180), 3.141592653589793);
    });
  });

  describe('degreesToGradians', () => {
    it('converts degrees to gradians correctly', () => {
      assert.strictEqual(Geometry.degreesToGradians(45), 50);
      assert.strictEqual(Geometry.degreesToGradians(180), 200);
    });
  });

  describe('degreesToTurns', () => {
    it('converts degrees to turns correctly', () => {
      assert.strictEqual(Geometry.degreesToTurns(45), 0.125);
      assert.strictEqual(Geometry.degreesToTurns(180), 0.5);
    });
  });

  describe('radiansToDegrees', () => {
    it('converts radians to degrees correctly', () => {
      assert.strictEqual(Geometry.radiansToDegrees(1), 57.29577951308232);
      assert.strictEqual(Geometry.radiansToDegrees(1.5), 85.94366926962348);
    });
  });

  describe('radiansToGradians', () => {
    it('converts radians to gradians correctly', () => {
      assert.strictEqual(Geometry.radiansToGradians(1), 63.66197723675813);
      assert.strictEqual(Geometry.radiansToGradians(1.5), 95.4929658551372);
    });
  });

  describe('radiansToTurns', () => {
    it('converts radians to turns correctly', () => {
      assert.strictEqual(Geometry.radiansToTurns(1), 0.15915494309189535);
      assert.strictEqual(Geometry.radiansToTurns(1.5), 0.238732414637843);
    });
  });

  describe('gradiansToRadians', () => {
    it('converts gradians to radians correctly', () => {
      assert.strictEqual(Geometry.gradiansToRadians(50), 0.7853981633974483);
      assert.strictEqual(Geometry.gradiansToRadians(200), 3.141592653589793);
    });
  });

  describe('turnsToRadians', () => {
    it('converts turns to radians correctly', () => {
      assert.strictEqual(Geometry.gradiansToRadians(0.5), 0.007853981633974483);
      assert.strictEqual(Geometry.gradiansToRadians(1), 0.015707963267948967);
    });
  });
});
