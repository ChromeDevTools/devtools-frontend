// ../../front_end/models/network_time_calculator/NetworkTimeCalculator.ts
...
// ../../front_end/models/network_time_calculator/RequestTimeRanges.ts
var RequestTimeRangeNames = /* @__PURE__ */ ((RequestTimeRangeNames2) => {
...
function calculateRequestTimeRanges(request, navigationStart) {
  ...
  if (serviceWorkerRouterInfo) {
    if (timing.workerRouterEvaluationStart) {
      ...
      if (serviceWorkerRouterInfo?.matchedSourceType === Network.ServiceWorkerRouterSource.Cache && timing.workerCacheLookupStart) {
        routerEvaluationEnd = timing.workerCacheLookupStart;
      } else if (serviceWorkerRouterInfo?.actualSourceType === Network.ServiceWorkerRouterSource.FetchEvent) {
    ...
    if (timing.workerCacheLookupStart) {
      ...
      if (serviceWorkerRouterInfo?.actualSourceType === Network.ServiceWorkerRouterSource.Cache) {
