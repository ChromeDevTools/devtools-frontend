...
function createLanternRequest(parsedTrace, workerThreads, request) {
  ...
  const initiator = request.args.data.initiator ?? { type: Network.InitiatorType.Other };
...
var TraceProcessor = class _TraceProcessor extends EventTarget {
  ...
  async parse(traceEvents, options) {
    ...
    if (typeof options.isCPUProfile === "undefined" && options.metadata) {
      options.isCPUProfile = options.metadata.dataOrigin === Types3.File.DataOrigin.CPU_PROFILE;
    }
  ...
  #computeInsightsForInitialTracePeriod(data, navigations, options) {
    const bounds = navigations.length > 0 ? Helpers4.Timing.traceWindowFromMicroSeconds(
      data.Meta.traceBounds.min,
      Types3.Timing.Micro(navigations[0].ts - 1)
...
function maybeInitSylesMap() {
  ...
  eventStylesMap = {
    [Types5.Events.Name.RUN_TASK]: new TimelineRecordStyle(i18nString(UIStrings.task), defaultCategoryStyles.other),
    [Types5.Events.Name.PROFILE_CALL]: new TimelineRecordStyle(i18nString(UIStrings.jsFrame), defaultCategoryStyles.scripting),
    [Types5.Events.Name.JS_SAMPLE]: new TimelineRecordStyle(Types5.Events.Name.JS_SAMPLE, defaultCategoryStyles.scripting),
    [Types5.Events.Name.PROGRAM]: new TimelineRecordStyle(i18nString(UIStrings.other), defaultCategoryStyles.other),
    [Types5.Events.Name.START_PROFILING]: new TimelineRecordStyle(i18nString(UIStrings.profilingOverhead), defaultCategoryStyles.other),
    [Types5.Events.Name.ANIMATION]: new TimelineRecordStyle(i18nString(UIStrings.animation), defaultCategoryStyles.rendering),
    [Types5.Events.Name.EVENT_DISPATCH]: new TimelineRecordStyle(i18nString(UIStrings.event), defaultCategoryStyles.scripting),
    [Types5.Events.Name.REQUEST_MAIN_THREAD_FRAME]: new TimelineRecordStyle(
      i18nString(UIStrings.requestMainThreadFrame),
      defaultCategoryStyles.rendering,
      true
    ),
    [Types5.Events.Name.BEGIN_FRAME]: new TimelineRecordStyle(
      i18nString(UIStrings.frameStart),
      defaultCategoryStyles.rendering,
      true
    ),
    [Types5.Events.Name.BEGIN_MAIN_THREAD_FRAME]: new TimelineRecordStyle(
      i18nString(UIStrings.frameStartMainThread),
      defaultCategoryStyles.rendering,
      true
    ),
    [Types5.Events.Name.DRAW_FRAME]: new TimelineRecordStyle(
      i18nString(UIStrings.drawFrame),
      defaultCategoryStyles.rendering,
      true
    ),
    [Types5.Events.Name.HIT_TEST]: new TimelineRecordStyle(i18nString(UIStrings.hitTest), defaultCategoryStyles.rendering),
    [Types5.Events.Name.SCHEDULE_STYLE_RECALCULATION]: new TimelineRecordStyle(
      i18nString(UIStrings.scheduleStyleRecalculation),
      defaultCategoryStyles.rendering
    ),
    [Types5.Events.Name.RECALC_STYLE]: new TimelineRecordStyle(i18nString(UIStrings.recalculateStyle), defaultCategoryStyles.rendering),
    [Types5.Events.Name.INVALIDATE_LAYOUT]: new TimelineRecordStyle(
      i18nString(UIStrings.invalidateLayout),
      defaultCategoryStyles.rendering,
      true
    ),
    [Types5.Events.Name.LAYERIZE]: new TimelineRecordStyle(i18nString(UIStrings.layerize), defaultCategoryStyles.rendering),
    [Types5.Events.Name.LAYOUT]: new TimelineRecordStyle(i18nString(UIStrings.layout), defaultCategoryStyles.rendering),
    [Types5.Events.Name.PAINT_SETUP]: new TimelineRecordStyle(i18nString(UIStrings.paintSetup), defaultCategoryStyles.painting),
    [Types5.Events.Name.PAINT_IMAGE]: new TimelineRecordStyle(
      i18nString(UIStrings.paintImage),
      defaultCategoryStyles.painting,
      true
    ),
    [Types5.Events.Name.UPDATE_LAYER]: new TimelineRecordStyle(
      i18nString(UIStrings.updateLayer),
      defaultCategoryStyles.painting,
      true
    ),
    [Types5.Events.Name.UPDATE_LAYER_TREE]: new TimelineRecordStyle(i18nString(UIStrings.updateLayerTree), defaultCategoryStyles.rendering),
    [Types5.Events.Name.PAINT]: new TimelineRecordStyle(i18nString(UIStrings.paint), defaultCategoryStyles.painting),
    [Types5.Events.Name.PRE_PAINT]: new TimelineRecordStyle(i18nString(UIStrings.prePaint), defaultCategoryStyles.rendering),
    [Types5.Events.Name.RASTER_TASK]: new TimelineRecordStyle(i18nString(UIStrings.rasterizePaint), defaultCategoryStyles.painting),
    [Types5.Events.Name.SCROLL_LAYER]: new TimelineRecordStyle(i18nString(UIStrings.scroll), defaultCategoryStyles.rendering),
    [Types5.Events.Name.COMMIT]: new TimelineRecordStyle(i18nString(UIStrings.commit), defaultCategoryStyles.painting),
    [Types5.Events.Name.COMPOSITE_LAYERS]: new TimelineRecordStyle(i18nString(UIStrings.compositeLayers), defaultCategoryStyles.painting),
    [Types5.Events.Name.COMPUTE_INTERSECTION]: new TimelineRecordStyle(
      i18nString(UIStrings.computeIntersections),
      defaultCategoryStyles.rendering
    ),
    [Types5.Events.Name.PARSE_HTML]: new TimelineRecordStyle(i18nString(UIStrings.parseHtml), defaultCategoryStyles.loading),
    [Types5.Events.Name.PARSE_AUTHOR_STYLE_SHEET]: new TimelineRecordStyle(i18nString(UIStrings.parseStylesheet), defaultCategoryStyles.loading),
    [Types5.Events.Name.TIMER_INSTALL]: new TimelineRecordStyle(i18nString(UIStrings.installTimer), defaultCategoryStyles.scripting),
    [Types5.Events.Name.TIMER_REMOVE]: new TimelineRecordStyle(i18nString(UIStrings.removeTimer), defaultCategoryStyles.scripting),
    [Types5.Events.Name.TIMER_FIRE]: new TimelineRecordStyle(i18nString(UIStrings.timerFired), defaultCategoryStyles.scripting),
    [Types5.Events.Name.XHR_READY_STATE_CHANGED]: new TimelineRecordStyle(
      i18nString(UIStrings.xhrReadyStateChange),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.XHR_LOAD]: new TimelineRecordStyle(i18nString(UIStrings.xhrLoad), defaultCategoryStyles.scripting),
    [Types5.Events.Name.COMPILE]: new TimelineRecordStyle(i18nString(UIStrings.compileScript), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CACHE_SCRIPT]: new TimelineRecordStyle(i18nString(UIStrings.cacheScript), defaultCategoryStyles.scripting),
    [Types5.Events.Name.COMPILE_CODE]: new TimelineRecordStyle(i18nString(UIStrings.compileCode), defaultCategoryStyles.scripting),
    [Types5.Events.Name.OPTIMIZE_CODE]: new TimelineRecordStyle(i18nString(UIStrings.optimizeCode), defaultCategoryStyles.scripting),
    [Types5.Events.Name.EVALUATE_SCRIPT]: new TimelineRecordStyle(i18nString(UIStrings.evaluateScript), defaultCategoryStyles.scripting),
    [Types5.Events.Name.COMPILE_MODULE]: new TimelineRecordStyle(i18nString(UIStrings.compileModule), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CACHE_MODULE]: new TimelineRecordStyle(i18nString(UIStrings.cacheModule), defaultCategoryStyles.scripting),
    [Types5.Events.Name.EVALUATE_MODULE]: new TimelineRecordStyle(i18nString(UIStrings.evaluateModule), defaultCategoryStyles.scripting),
    [Types5.Events.Name.STREAMING_COMPILE_SCRIPT]: new TimelineRecordStyle(i18nString(UIStrings.streamingCompileTask), defaultCategoryStyles.other),
    [Types5.Events.Name.STREAMING_COMPILE_SCRIPT_WAITING]: new TimelineRecordStyle(i18nString(UIStrings.waitingForNetwork), defaultCategoryStyles.idle),
    [Types5.Events.Name.STREAMING_COMPILE_SCRIPT_PARSING]: new TimelineRecordStyle(i18nString(UIStrings.parseAndCompile), defaultCategoryStyles.scripting),
    [Types5.Events.Name.BACKGROUND_DESERIALIZE]: new TimelineRecordStyle(
      i18nString(UIStrings.deserializeCodeCache),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.FINALIZE_DESERIALIZATION]: new TimelineRecordStyle(i18nString(UIStrings.profilingOverhead), defaultCategoryStyles.other),
    [Types5.Events.Name.WASM_STREAM_FROM_RESPONSE_CALLBACK]: new TimelineRecordStyle(
      i18nString(UIStrings.streamingWasmResponse),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.WASM_COMPILED_MODULE]: new TimelineRecordStyle(i18nString(UIStrings.compiledWasmModule), defaultCategoryStyles.scripting),
    [Types5.Events.Name.WASM_CACHED_MODULE]: new TimelineRecordStyle(i18nString(UIStrings.cachedWasmModule), defaultCategoryStyles.scripting),
    [Types5.Events.Name.WASM_MODULE_CACHE_HIT]: new TimelineRecordStyle(i18nString(UIStrings.wasmModuleCacheHit), defaultCategoryStyles.scripting),
    [Types5.Events.Name.WASM_MODULE_CACHE_INVALID]: new TimelineRecordStyle(
      i18nString(UIStrings.wasmModuleCacheInvalid),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.FRAME_STARTED_LOADING]: new TimelineRecordStyle(
      i18nString(UIStrings.frameStartedLoading),
      defaultCategoryStyles.loading,
      true
    ),
    [Types5.Events.Name.MARK_LOAD]: new TimelineRecordStyle(
      i18nString(UIStrings.onloadEvent),
      defaultCategoryStyles.scripting,
      true
    ),
    [Types5.Events.Name.MARK_DOM_CONTENT]: new TimelineRecordStyle(
      i18nString(UIStrings.domcontentloadedEvent),
      defaultCategoryStyles.scripting,
      true
    ),
    [Types5.Events.Name.SOFT_NAVIGATION_START]: new TimelineRecordStyle(
      i18nString(UIStrings.softNavigationStart),
      defaultCategoryStyles.loading,
      true
    ),
    [Types5.Events.Name.MARK_FIRST_PAINT]: new TimelineRecordStyle(
      i18nString(UIStrings.firstPaint),
      defaultCategoryStyles.painting,
      true
    ),
    [Types5.Events.Name.MARK_FCP]: new TimelineRecordStyle(
      i18nString(UIStrings.firstContentfulPaint),
      defaultCategoryStyles.rendering,
      true
    ),
    [Types5.Events.Name.MARK_SOFT_FCP]: new TimelineRecordStyle(
      i18nString(UIStrings.softFirstContentfulPaint),
      defaultCategoryStyles.rendering,
      true
    ),
    [Types5.Events.Name.MARK_LCP_CANDIDATE]: new TimelineRecordStyle(
      i18nString(UIStrings.largestContentfulPaint),
      defaultCategoryStyles.rendering,
      true
    ),
    [Types5.Events.Name.MARK_LCP_CANDIDATE_FOR_SOFT_NAVIGATION]: new TimelineRecordStyle(
      i18nString(UIStrings.softLargestContentfulPaint),
      defaultCategoryStyles.rendering,
      true
    ),
    [Types5.Events.Name.TIME_STAMP]: new TimelineRecordStyle(i18nString(UIStrings.timestamp), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CONSOLE_TIME]: new TimelineRecordStyle(i18nString(UIStrings.consoleTime), defaultCategoryStyles.scripting),
    [Types5.Events.Name.USER_TIMING]: new TimelineRecordStyle(i18nString(UIStrings.userTiming), defaultCategoryStyles.scripting),
    [Types5.Events.Name.RESOURCE_WILL_SEND_REQUEST]: new TimelineRecordStyle(i18nString(UIStrings.willSendRequest), defaultCategoryStyles.loading),
    [Types5.Events.Name.RESOURCE_SEND_REQUEST]: new TimelineRecordStyle(i18nString(UIStrings.sendRequest), defaultCategoryStyles.loading),
    [Types5.Events.Name.RESOURCE_RECEIVE_RESPONSE]: new TimelineRecordStyle(i18nString(UIStrings.receiveResponse), defaultCategoryStyles.loading),
    [Types5.Events.Name.RESOURCE_FINISH]: new TimelineRecordStyle(i18nString(UIStrings.finishLoading), defaultCategoryStyles.loading),
    [Types5.Events.Name.RESOURCE_RECEIVE_DATA]: new TimelineRecordStyle(i18nString(UIStrings.receiveData), defaultCategoryStyles.loading),
    [Types5.Events.Name.RUN_MICROTASKS]: new TimelineRecordStyle(i18nString(UIStrings.runMicrotasks), defaultCategoryStyles.scripting),
    [Types5.Events.Name.FUNCTION_CALL]: new TimelineRecordStyle(i18nString(UIStrings.functionCall), defaultCategoryStyles.scripting),
    [Types5.Events.Name.GC]: new TimelineRecordStyle(i18nString(UIStrings.gcEvent), defaultCategoryStyles.scripting),
    [Types5.Events.Name.MAJOR_GC]: new TimelineRecordStyle(i18nString(UIStrings.majorGc), defaultCategoryStyles.scripting),
    [Types5.Events.Name.MINOR_GC]: new TimelineRecordStyle(i18nString(UIStrings.minorGc), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CPPGC_SWEEP]: new TimelineRecordStyle(i18nString(UIStrings.cppGc), defaultCategoryStyles.scripting),
    [Types5.Events.Name.REQUEST_ANIMATION_FRAME]: new TimelineRecordStyle(
      i18nString(UIStrings.requestAnimationFrame),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.CANCEL_ANIMATION_FRAME]: new TimelineRecordStyle(
      i18nString(UIStrings.cancelAnimationFrame),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.FIRE_ANIMATION_FRAME]: new TimelineRecordStyle(
      i18nString(UIStrings.animationFrameFired),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.REQUEST_IDLE_CALLBACK]: new TimelineRecordStyle(
      i18nString(UIStrings.requestIdleCallback),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.CANCEL_IDLE_CALLBACK]: new TimelineRecordStyle(i18nString(UIStrings.cancelIdleCallback), defaultCategoryStyles.scripting),
    [Types5.Events.Name.FIRE_IDLE_CALLBACK]: new TimelineRecordStyle(i18nString(UIStrings.fireIdleCallback), defaultCategoryStyles.scripting),
    [Types5.Events.Name.WEB_SOCKET_CREATE]: new TimelineRecordStyle(i18nString(UIStrings.createWebsocket), defaultCategoryStyles.scripting),
    [Types5.Events.Name.WEB_SOCKET_SEND_HANDSHAKE_REQUEST]: new TimelineRecordStyle(
      i18nString(UIStrings.sendWebsocketHandshake),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.WEB_SOCKET_RECEIVE_HANDSHAKE_REQUEST]: new TimelineRecordStyle(
      i18nString(UIStrings.receiveWebsocketHandshake),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.WEB_SOCKET_DESTROY]: new TimelineRecordStyle(i18nString(UIStrings.destroyWebsocket), defaultCategoryStyles.scripting),
    [Types5.Events.Name.WEB_SOCKET_SEND]: new TimelineRecordStyle(
      i18nString(UIStrings.wsMessageSent),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.WEB_SOCKET_RECEIVE]: new TimelineRecordStyle(
      i18nString(UIStrings.wsMessageReceived),
      defaultCategoryStyles.scripting
    ),
    [Types5.Events.Name.EMBEDDER_CALLBACK]: new TimelineRecordStyle(i18nString(UIStrings.embedderCallback), defaultCategoryStyles.scripting),
    [Types5.Events.Name.DECODE_IMAGE]: new TimelineRecordStyle(i18nString(UIStrings.imageDecode), defaultCategoryStyles.painting),
    [Types5.Events.Name.GPU_TASK]: new TimelineRecordStyle(i18nString(UIStrings.gpu), defaultCategoryStyles.gpu),
    [Types5.Events.Name.GC_COLLECT_GARBARGE]: new TimelineRecordStyle(i18nString(UIStrings.domGc), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CRYPTO_DO_ENCRYPT]: new TimelineRecordStyle(i18nString(UIStrings.encrypt), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CRYPTO_DO_ENCRYPT_REPLY]: new TimelineRecordStyle(i18nString(UIStrings.encryptReply), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CRYPTO_DO_DECRYPT]: new TimelineRecordStyle(i18nString(UIStrings.decrypt), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CRYPTO_DO_DECRYPT_REPLY]: new TimelineRecordStyle(i18nString(UIStrings.decryptReply), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CRYPTO_DO_DIGEST]: new TimelineRecordStyle(i18nString(UIStrings.digest), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CRYPTO_DO_DIGEST_REPLY]: new TimelineRecordStyle(i18nString(UIStrings.digestReply), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CRYPTO_DO_SIGN]: new TimelineRecordStyle(i18nString(UIStrings.sign), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CRYPTO_DO_SIGN_REPLY]: new TimelineRecordStyle(i18nString(UIStrings.signReply), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CRYPTO_DO_VERIFY]: new TimelineRecordStyle(i18nString(UIStrings.verify), defaultCategoryStyles.scripting),
    [Types5.Events.Name.CRYPTO_DO_VERIFY_REPLY]: new TimelineRecordStyle(i18nString(UIStrings.verifyReply), defaultCategoryStyles.scripting),
    [Types5.Events.Name.ASYNC_TASK]: new TimelineRecordStyle(i18nString(UIStrings.asyncTask), defaultCategoryStyles.async),
    [Types5.Events.Name.LAYOUT_SHIFT]: new TimelineRecordStyle(
    ...
    [Types5.Events.Name.SYNTHETIC_LAYOUT_SHIFT]: new TimelineRecordStyle(i18nString(UIStrings.layoutShift), defaultCategoryStyles.experience),
    [Types5.Events.Name.SYNTHETIC_LAYOUT_SHIFT_CLUSTER]: new TimelineRecordStyle(i18nString(UIStrings.layoutShiftCluster), defaultCategoryStyles.experience),
    [Types5.Events.Name.EVENT_TIMING]: new TimelineRecordStyle(i18nString(UIStrings.eventTiming), defaultCategoryStyles.experience),
    [Types5.Events.Name.HANDLE_POST_MESSAGE]: new TimelineRecordStyle(i18nString(UIStrings.onMessage), defaultCategoryStyles.messaging),
    [Types5.Events.Name.SCHEDULE_POST_MESSAGE]: new TimelineRecordStyle(i18nString(UIStrings.schedulePostMessage), defaultCategoryStyles.messaging),
    [Types5.Events.Name.SCHEDULE_POST_TASK_CALLBACK]: new TimelineRecordStyle(i18nString(UIStrings.schedulePostTaskCallback), defaultCategoryStyles.scripting),
    [Types5.Events.Name.RUN_POST_TASK_CALLBACK]: new TimelineRecordStyle(i18nString(UIStrings.runPostTaskCallback), defaultCategoryStyles.scripting),
    [Types5.Events.Name.ABORT_POST_TASK_CALLBACK]: new TimelineRecordStyle(i18nString(UIStrings.abortPostTaskCallback), defaultCategoryStyles.scripting),
    [Types5.Events.Name.V8_CONSOLE_RUN_TASK]: new TimelineRecordStyle(i18nString(UIStrings.consoleTaskRun), defaultCategoryStyles.scripting)
  };
...
function markerDetailsForEvent(event) {
  ...
  if (Types5.Events.isAnyFirstContentfulPaint(event)) {
    ...
    title = Types5.Events.isSoftFirstContentfulPaint(event) ? Handlers5.ModelHandlers.PageLoadMetrics.MetricName.SOFT_FCP : Handlers5.ModelHandlers.PageLoadMetrics.MetricName.FCP;
  }
  if (Types5.Events.isAnyLargestContentfulPaintCandidate(event)) {
    color = "var(--sys-color-green)";
    title = Types5.Events.isSoftLargestContentfulPaintCandidate(event) ? Handlers5.ModelHandlers.PageLoadMetrics.MetricName.SOFT_LCP : Handlers5.ModelHandlers.PageLoadMetrics.MetricName.LCP;
  }
  if (Types5.Events.isNavigationStart(event) || Types5.Events.isSoftNavigationStart(event)) {
    color = "var(--color-text-primary)";
    title = Types5.Events.isSoftNavigationStart(event) ? Handlers5.ModelHandlers.PageLoadMetrics.MetricName.SOFT_NAV : Handlers5.ModelHandlers.PageLoadMetrics.MetricName.NAV;
  }
  if (Types5.Events.isMarkDOMContent(event)) {
    color = "var(--color-text-disabled)";
    title = Handlers5.ModelHandlers.PageLoadMetrics.MetricName.DCL;
  }
  if (Types5.Events.isMarkLoad(event)) {
    color = "var(--color-text-disabled)";
    title = Handlers5.ModelHandlers.PageLoadMetrics.MetricName.L;
  }
  return { color, title };
}
