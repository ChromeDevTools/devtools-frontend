...
/**
 * @typedef {{
 *     sortingFunction: (!function(!WebInspector.NetworkDataGridNode,
 * !WebInspector.NetworkDataGridNode):number|undefined),
...
WebInspector.NetworkLogViewColumns._defaultColumns = [
  ...
  },
  {
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.RequestPropertyComparator.bind(null, 'requestMethod')
    }
  },
  {
    id: 'status',
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.RequestPropertyComparator.bind(null, 'statusCode')
    }
  },
  {
    id: 'protocol',
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.RequestPropertyComparator.bind(null, 'protocol')
    }
  },
  {
    id: 'scheme',
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.RequestPropertyComparator.bind(null, 'scheme')
    }
  },
  {
    id: 'domain',
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.RequestPropertyComparator.bind(null, 'domain')
    }
  },
  {
    id: 'remoteaddress',
  ...
  },
  {
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.RequestPropertyComparator.bind(null, 'duration')
    }
  },
  {
    id: 'priority',
  ...
  },
  {
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.RequestPropertyComparator.bind(null, 'connectionId')
    }
  },
  {
    id: 'cache-control',
    ...
    sortConfig: {
      sortingFunction: WebInspector.NetworkDataGridNode.ResponseHeaderStringComparator.bind(
          null, 'cache-control')
    }
  },
  {
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.ResponseHeaderStringComparator.bind(null, 'connection')
    }
  },
  {
    id: 'content-encoding',
  ...
  },
  {
    ...
    align: WebInspector.DataGrid.Align.Right,
    sortConfig: {
      sortingFunction: WebInspector.NetworkDataGridNode.ResponseHeaderNumberComparator.bind(
          null, 'content-length')
    }
  },
  {
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.ResponseHeaderStringComparator.bind(null, 'etag')
    }
  },
  {
    id: 'keep-alive',
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.ResponseHeaderStringComparator.bind(null, 'keep-alive')
    }
  },
  {
    id: 'last-modified',
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.ResponseHeaderDateComparator.bind(null, 'last-modified')
    }
  },
  {
    id: 'server',
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.ResponseHeaderStringComparator.bind(null, 'server')
    }
  },
  {
    id: 'vary',
    ...
    sortConfig: {
      sortingFunction:
          WebInspector.NetworkDataGridNode.ResponseHeaderStringComparator.bind(null, 'vary')
    }
  },
  {
    id: 'timeline',
      ...
      entries: [
        {
          ...
          sortingFunction:
              WebInspector.NetworkDataGridNode.RequestPropertyComparator.bind(null, 'startTime'),
        ...
        },
        {
          ...
          sort: WebInspector.DataGrid.Order.Ascending,
          sortingFunction: WebInspector.NetworkDataGridNode.RequestPropertyComparator.bind(
              null, 'responseReceivedTime'),
          calculator: WebInspector.NetworkLogViewColumns._calculatorTypes.Time
        },
        {
          id: 'endtime',
          ...
          sort: WebInspector.DataGrid.Order.Ascending,
          sortingFunction:
              WebInspector.NetworkDataGridNode.RequestPropertyComparator.bind(null, 'endTime'),
          calculator: WebInspector.NetworkLogViewColumns._calculatorTypes.Time
        },
        {
          id: 'duration',
        ...
        },
        {
          ...
          sort: WebInspector.DataGrid.Order.Descending,
          sortingFunction:
              WebInspector.NetworkDataGridNode.RequestPropertyComparator.bind(null, 'latency'),
          calculator: WebInspector.NetworkLogViewColumns._calculatorTypes.Duration
        }
      ]
    }
...
WebInspector.NetworkLogViewColumns.prototype = {
  willHide: function() { this._popoverHelper.hidePopover(); },
  ...
  createGrid: function(timeCalculator, durationCalculator) {
    ...
    for (var currentConfigColumn of defaultColumns) {
      ...
      if (columnConfig.subtitle)
        columnConfig.titleDOMFragment =
            this._makeHeaderFragment(columnConfig.title, columnConfig.subtitle);
    ...
    this._calculatorsMap.set(
        WebInspector.NetworkLogViewColumns._calculatorTypes.Time, timeCalculator);
    this._calculatorsMap.set(
        WebInspector.NetworkLogViewColumns._calculatorTypes.Duration, durationCalculator);

    this._popoverHelper = new WebInspector.PopoverHelper(
        this._networkLogView.element, this._getPopoverAnchor.bind(this),
    ...
    this._dataGrid.addEventListener(
        WebInspector.DataGrid.Events.SortingChanged, this._sortHandler, this);
    this._dataGrid.addEventListener(
        WebInspector.DataGrid.Events.ColumnsResized, this.updateDividersIfNeeded, this);
    ...
    this._dataGrid.markColumnAsSortedBy(
        WebInspector.NetworkLogViewColumns._initialSortColumn,
  ...
  sortByCurrentColumn: function() { this._sortHandler(); },
  ...
  _sortHandler: function() {
    ...
    this._dataGrid.sortNodes(
        columnConfig.sortConfig.sortingFunction, !this._dataGrid.isSortOrderAscending());
  ...
  _sortByDropdownItem: function(columnConfig) {
    ...
    var selectedItemConfig =
        columnConfig.sortConfig.entries[selectedIndex - 1];  // -1 because of placeholder.
  ...
  contextMenu: function(event) {
    ...
    for (var columnConfig of nonResponseHeaders)
      contextMenu.appendCheckboxItem(
          columnConfig.title, this._toggleColumnVisibility.bind(this, columnConfig),
    ...
    responseSubMenu.appendItem(
        WebInspector.UIString('Manage Header Columns\u2026'),
        this._manageCustomHeaderDialog.bind(this));
  ...
  _manageCustomHeaderDialog: function() {
    ...
    var manageCustomHeaders = new WebInspector.NetworkManageCustomHeadersView(
        customHeaders, headerTitle => !!this._addCustomHeader(headerTitle),
        this._changeCustomHeader.bind(this), this._removeCustomHeader.bind(this));
  ...
  _addCustomHeader: function(headerTitle, headerId, index) {
    ...
    var columnConfig = /** @type {!WebInspector.NetworkLogViewColumns.Descriptor} */ (Object.assign(
        /** @type {!Object} */ ({}), WebInspector.NetworkLogViewColumns._defaultColumnConfig, {
          id: headerId,
          title: headerTitle,
          isResponseHeader: true,
          isCustomHeader: true,
          ...
          sortConfig: {
            sortingFunction:
                WebInspector.NetworkDataGridNode.ResponseHeaderStringComparator.bind(null, headerId)
          }
        }));
    this._columns.splice(index, 0, columnConfig);
    if (this._dataGrid)
      this._dataGrid.addColumn(
          WebInspector.NetworkLogViewColumns._convertToDataGridDescriptor(columnConfig), index);
    this._saveColumns();
    this._updateColumns();
    return columnConfig;
  },
  ...
  updateDividersIfNeeded: function() {
    ...
    var calculator =
        this._calculatorsMap.get(WebInspector.NetworkLogViewColumns._calculatorTypes.Time);
  ...
  _onHidePopover: function() { this._popupLinkifier.reset(); },
  ...
  hideEventDividers: function() { this._timelineGrid.hideEventDividers(); },

  showEventDividers: function() { this._timelineGrid.showEventDividers(); },
