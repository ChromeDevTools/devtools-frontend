  ...
  ` :
    ...
    if (sessionAndEvents.session) {
        ...
        <devtools-report>
          ...
          ${renderKeyValue(i18nString(UIStrings.expiryDate), new Date(sessionAndEvents.session.expiryDate * 1000).toLocaleString(), 'dbsc-expiry-date')}
          ${renderKeyValue(i18nString(UIStrings.cachedChallenge), sessionAndEvents.session.cachedChallenge || '', 'dbsc-cached-challenge')}
          ${renderKeyValue(i18nString(UIStrings.allowedRefreshInitiators), sessionAndEvents.session.allowedRefreshInitiators.join(', '), 'dbsc-allowed-refresh-initiators')}
          ...
          ${renderKeyValue(i18nString(UIStrings.includeSite), boolToString(inclusionRules.includeSite), 'dbsc-include-site')}
        </devtools-report>
    ...
    const creationEventDetails = selectedEvent?.creationEventDetails &&
        html `
            ${renderKeyValue(i18nString(UIStrings.fetchResult), fetchResultToString(selectedEvent.creationEventDetails.fetchResult), 'dbsc-creation-fetch-result')}
            ${selectedEvent.creationEventDetails.newSession &&
            html `
             ${renderKeyValue(i18nString(UIStrings.updatedSessionConfig), i18nString(UIStrings.yes), 'dbsc-creation-updated-session-config')}
            `}
          `;
    const refreshEventDetails = selectedEvent?.refreshEventDetails &&
        html `
          ${renderKeyValue(i18nString(UIStrings.refreshResult), refreshResultToString(selectedEvent.refreshEventDetails.refreshResult), 'dbsc-refresh-result')}
          ${renderKeyValue(i18nString(UIStrings.causedAnyRequestDeferrals), boolToString(!selectedEvent.refreshEventDetails.wasFullyProactiveRefresh), 'dbsc-refresh-was-fully-proactive-refresh')}
            ${selectedEvent.refreshEventDetails.fetchResult &&
            html `
              ${renderKeyValue(i18nString(UIStrings.fetchResult), fetchResultToString(selectedEvent.refreshEventDetails.fetchResult), 'dbsc-refresh-fetch-result')}
            `}
            ${selectedEvent.refreshEventDetails.newSession &&
            html `
              ${renderKeyValue(i18nString(UIStrings.updatedSessionConfig), i18nString(UIStrings.yes), 'dbsc-refresh-updated-session-config')}
            `}
          `;
    const challengeEventDetails = selectedEvent?.challengeEventDetails &&
        html `
          ${renderKeyValue(i18nString(UIStrings.challengeResult), challengeResultToString(selectedEvent.challengeEventDetails.challengeResult), 'dbsc-challenge-result')}
          ${renderKeyValue(i18nString(UIStrings.challenge), selectedEvent.challengeEventDetails.challenge, 'dbsc-challenge')}
          `;
    const terminationEventDetails = selectedEvent?.terminationEventDetails &&
        html `
          ${renderKeyValue(i18nString(UIStrings.deletionReason), deletionReasonToString(selectedEvent.terminationEventDetails.deletionReason), 'dbsc-termination-reason')}
          `;
    const eventDetailsContentHtml = selectedEvent ?
        ...
        <devtools-report>
          ...
          ${renderKeyValue(i18nString(UIStrings.eventResult), succeededToString(selectedEvent.succeeded), 'dbsc-event-result')}
...
export class DeviceBoundSessionsView extends UI.Widget.VBox {
    ...
    #attachModel(model) {
        if (this.#model) {
            ...
            this.#model.removeEventListener("CLEAR_EVENTS" /* DeviceBoundSessionModelEvents.CLEAR_EVENTS */, this.performUpdate, this);
        }
        this.#model = model;
        this.#model.addEventListener("EVENT_OCCURRED" /* DeviceBoundSessionModelEvents.EVENT_OCCURRED */, this.performUpdate, this);
        this.#model.addEventListener("CLEAR_EVENTS" /* DeviceBoundSessionModelEvents.CLEAR_EVENTS */, this.performUpdate, this);
...
function fetchResultToString(fetchResult) {
    switch (fetchResult) {
        ...
        case "InvalidChallenge" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidChallenge */:
            return i18nString(UIStrings.invalidChallenge);
        case "TooManyChallenges" /* Protocol.Network.DeviceBoundSessionFetchResult.TooManyChallenges */:
            return i18nString(UIStrings.tooManyChallenges);
        case "InvalidFetcherUrl" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidFetcherUrl */:
            return i18nString(UIStrings.invalidFetcherUrl);
        case "InvalidRefreshUrl" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidRefreshUrl */:
            return i18nString(UIStrings.invalidRefreshUrl);
        case "TransientHttpError" /* Protocol.Network.DeviceBoundSessionFetchResult.TransientHttpError */:
            return i18nString(UIStrings.transientHttpError);
        case "ScopeOriginSameSiteMismatch" /* Protocol.Network.DeviceBoundSessionFetchResult.ScopeOriginSameSiteMismatch */:
            return i18nString(UIStrings.scopeOriginSameSiteMismatch);
        case "RefreshUrlSameSiteMismatch" /* Protocol.Network.DeviceBoundSessionFetchResult.RefreshUrlSameSiteMismatch */:
            return i18nString(UIStrings.refreshUrlSameSiteMismatch);
        case "MismatchedSessionId" /* Protocol.Network.DeviceBoundSessionFetchResult.MismatchedSessionId */:
            return i18nString(UIStrings.mismatchedSessionId);
        case "MissingScope" /* Protocol.Network.DeviceBoundSessionFetchResult.MissingScope */:
            return i18nString(UIStrings.missingScope);
        case "NoCredentials" /* Protocol.Network.DeviceBoundSessionFetchResult.NoCredentials */:
            return i18nString(UIStrings.noCredentials);
        case "SubdomainRegistrationWellKnownUnavailable" /* Protocol.Network.DeviceBoundSessionFetchResult.SubdomainRegistrationWellKnownUnavailable */:
            return i18nString(UIStrings.subdomainRegistrationWellKnownUnavailable);
        case "SubdomainRegistrationUnauthorized" /* Protocol.Network.DeviceBoundSessionFetchResult.SubdomainRegistrationUnauthorized */:
            return i18nString(UIStrings.subdomainRegistrationUnauthorized);
        case "SubdomainRegistrationWellKnownMalformed" /* Protocol.Network.DeviceBoundSessionFetchResult.SubdomainRegistrationWellKnownMalformed */:
            return i18nString(UIStrings.subdomainRegistrationWellKnownMalformed);
        case "SessionProviderWellKnownUnavailable" /* Protocol.Network.DeviceBoundSessionFetchResult.SessionProviderWellKnownUnavailable */:
            return i18nString(UIStrings.sessionProviderWellKnownUnavailable);
        case "RelyingPartyWellKnownUnavailable" /* Protocol.Network.DeviceBoundSessionFetchResult.RelyingPartyWellKnownUnavailable */:
            return i18nString(UIStrings.relyingPartyWellKnownUnavailable);
        case "FederatedKeyThumbprintMismatch" /* Protocol.Network.DeviceBoundSessionFetchResult.FederatedKeyThumbprintMismatch */:
            return i18nString(UIStrings.federatedKeyThumbprintMismatch);
        case "InvalidFederatedSessionUrl" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidFederatedSessionUrl */:
            return i18nString(UIStrings.invalidFederatedSessionUrl);
        case "InvalidFederatedKey" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidFederatedKey */:
            return i18nString(UIStrings.invalidFederatedKey);
        case "TooManyRelyingOriginLabels" /* Protocol.Network.DeviceBoundSessionFetchResult.TooManyRelyingOriginLabels */:
            return i18nString(UIStrings.tooManyRelyingOriginLabels);
        case "BoundCookieSetForbidden" /* Protocol.Network.DeviceBoundSessionFetchResult.BoundCookieSetForbidden */:
            return i18nString(UIStrings.boundCookieSetForbidden);
        case "NetError" /* Protocol.Network.DeviceBoundSessionFetchResult.NetError */:
            return i18nString(UIStrings.netError);
        case "ProxyError" /* Protocol.Network.DeviceBoundSessionFetchResult.ProxyError */:
            return i18nString(UIStrings.proxyError);
        case "EmptySessionConfig" /* Protocol.Network.DeviceBoundSessionFetchResult.EmptySessionConfig */:
            return i18nString(UIStrings.emptySessionConfig);
        case "InvalidCredentialsConfig" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidCredentialsConfig */:
            return i18nString(UIStrings.invalidCredentialsConfig);
        case "InvalidCredentialsType" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidCredentialsType */:
            return i18nString(UIStrings.invalidCredentialsType);
        case "InvalidCredentialsEmptyName" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidCredentialsEmptyName */:
            return i18nString(UIStrings.invalidCredentialsEmptyName);
        case "InvalidCredentialsCookie" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidCredentialsCookie */:
            return i18nString(UIStrings.invalidCredentialsCookie);
        case "PersistentHttpError" /* Protocol.Network.DeviceBoundSessionFetchResult.PersistentHttpError */:
            return i18nString(UIStrings.persistentHttpError);
        case "RegistrationAttemptedChallenge" /* Protocol.Network.DeviceBoundSessionFetchResult.RegistrationAttemptedChallenge */:
            return i18nString(UIStrings.registrationAttemptedChallenge);
        case "InvalidScopeOrigin" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidScopeOrigin */:
            return i18nString(UIStrings.invalidScopeOrigin);
        case "ScopeOriginContainsPath" /* Protocol.Network.DeviceBoundSessionFetchResult.ScopeOriginContainsPath */:
            return i18nString(UIStrings.scopeOriginContainsPath);
        case "RefreshInitiatorNotString" /* Protocol.Network.DeviceBoundSessionFetchResult.RefreshInitiatorNotString */:
            return i18nString(UIStrings.refreshInitiatorNotString);
        case "RefreshInitiatorInvalidHostPattern" /* Protocol.Network.DeviceBoundSessionFetchResult.RefreshInitiatorInvalidHostPattern */:
            return i18nString(UIStrings.refreshInitiatorInvalidHostPattern);
        case "InvalidScopeSpecification" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidScopeSpecification */:
            return i18nString(UIStrings.invalidScopeSpecification);
        case "MissingScopeSpecificationType" /* Protocol.Network.DeviceBoundSessionFetchResult.MissingScopeSpecificationType */:
            return i18nString(UIStrings.missingScopeSpecificationType);
        case "EmptyScopeSpecificationDomain" /* Protocol.Network.DeviceBoundSessionFetchResult.EmptyScopeSpecificationDomain */:
            return i18nString(UIStrings.emptyScopeSpecificationDomain);
        case "EmptyScopeSpecificationPath" /* Protocol.Network.DeviceBoundSessionFetchResult.EmptyScopeSpecificationPath */:
            return i18nString(UIStrings.emptyScopeSpecificationPath);
        case "InvalidScopeSpecificationType" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidScopeSpecificationType */:
            return i18nString(UIStrings.invalidScopeSpecificationType);
        case "InvalidScopeIncludeSite" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidScopeIncludeSite */:
            return i18nString(UIStrings.invalidScopeIncludeSite);
        case "MissingScopeIncludeSite" /* Protocol.Network.DeviceBoundSessionFetchResult.MissingScopeIncludeSite */:
            return i18nString(UIStrings.missingScopeIncludeSite);
        case "FederatedNotAuthorizedByProvider" /* Protocol.Network.DeviceBoundSessionFetchResult.FederatedNotAuthorizedByProvider */:
            return i18nString(UIStrings.federatedNotAuthorizedByProvider);
        case "FederatedNotAuthorizedByRelyingParty" /* Protocol.Network.DeviceBoundSessionFetchResult.FederatedNotAuthorizedByRelyingParty */:
            return i18nString(UIStrings.federatedNotAuthorizedByRelyingParty);
        case "SessionProviderWellKnownMalformed" /* Protocol.Network.DeviceBoundSessionFetchResult.SessionProviderWellKnownMalformed */:
            return i18nString(UIStrings.sessionProviderWellKnownMalformed);
        case "SessionProviderWellKnownHasProviderOrigin" /* Protocol.Network.DeviceBoundSessionFetchResult.SessionProviderWellKnownHasProviderOrigin */:
            return i18nString(UIStrings.sessionProviderWellKnownHasProviderOrigin);
        case "RelyingPartyWellKnownMalformed" /* Protocol.Network.DeviceBoundSessionFetchResult.RelyingPartyWellKnownMalformed */:
            return i18nString(UIStrings.relyingPartyWellKnownMalformed);
        case "RelyingPartyWellKnownHasRelyingOrigins" /* Protocol.Network.DeviceBoundSessionFetchResult.RelyingPartyWellKnownHasRelyingOrigins */:
            return i18nString(UIStrings.relyingPartyWellKnownHasRelyingOrigins);
        case "InvalidFederatedSessionProviderSessionMissing" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidFederatedSessionProviderSessionMissing */:
            return i18nString(UIStrings.invalidFederatedSessionProviderSessionMissing);
        case "InvalidFederatedSessionWrongProviderOrigin" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidFederatedSessionWrongProviderOrigin */:
            return i18nString(UIStrings.invalidFederatedSessionWrongProviderOrigin);
        case "InvalidCredentialsCookieCreationTime" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidCredentialsCookieCreationTime */:
            return i18nString(UIStrings.invalidCredentialsCookieCreationTime);
        case "InvalidCredentialsCookieName" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidCredentialsCookieName */:
            return i18nString(UIStrings.invalidCredentialsCookieName);
        case "InvalidCredentialsCookieParsing" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidCredentialsCookieParsing */:
            return i18nString(UIStrings.invalidCredentialsCookieParsing);
        case "InvalidCredentialsCookieUnpermittedAttribute" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidCredentialsCookieUnpermittedAttribute */:
            return i18nString(UIStrings.invalidCredentialsCookieUnpermittedAttribute);
        case "InvalidCredentialsCookieInvalidDomain" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidCredentialsCookieInvalidDomain */:
            return i18nString(UIStrings.invalidCredentialsCookieInvalidDomain);
        case "InvalidCredentialsCookiePrefix" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidCredentialsCookiePrefix */:
            return i18nString(UIStrings.invalidCredentialsCookiePrefix);
        case "InvalidScopeRulePath" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidScopeRulePath */:
            return i18nString(UIStrings.invalidScopeRulePath);
        case "InvalidScopeRuleHostPattern" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidScopeRuleHostPattern */:
            return i18nString(UIStrings.invalidScopeRuleHostPattern);
        case "ScopeRuleOriginScopedHostPatternMismatch" /* Protocol.Network.DeviceBoundSessionFetchResult.ScopeRuleOriginScopedHostPatternMismatch */:
            return i18nString(UIStrings.scopeRuleOriginScopedHostPatternMismatch);
        case "ScopeRuleSiteScopedHostPatternMismatch" /* Protocol.Network.DeviceBoundSessionFetchResult.ScopeRuleSiteScopedHostPatternMismatch */:
            return i18nString(UIStrings.scopeRuleSiteScopedHostPatternMismatch);
        case "SigningQuotaExceeded" /* Protocol.Network.DeviceBoundSessionFetchResult.SigningQuotaExceeded */:
            return i18nString(UIStrings.signingQuotaExceeded);
        case "InvalidConfigJson" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidConfigJson */:
            return i18nString(UIStrings.invalidConfigJson);
        case "InvalidFederatedSessionProviderFailedToRestoreKey" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidFederatedSessionProviderFailedToRestoreKey */:
            return i18nString(UIStrings.invalidFederatedSessionProviderFailedToRestoreKey);
        case "FailedToUnwrapKey" /* Protocol.Network.DeviceBoundSessionFetchResult.FailedToUnwrapKey */:
            return i18nString(UIStrings.failedToUnwrapKey);
        case "SessionDeletedDuringRefresh" /* Protocol.Network.DeviceBoundSessionFetchResult.SessionDeletedDuringRefresh */:
...
function refreshResultToString(refreshResult) {
    switch (refreshResult) {
        case "Refreshed" /* Protocol.Network.RefreshEventDetailsRefreshResult.Refreshed */:
            return i18nString(UIStrings.refreshed);
        case "InitializedService" /* Protocol.Network.RefreshEventDetailsRefreshResult.InitializedService */:
            return i18nString(UIStrings.initializedService);
        case "Unreachable" /* Protocol.Network.RefreshEventDetailsRefreshResult.Unreachable */:
...
function challengeResultToString(challengeResult) {
    switch (challengeResult) {
        case "Success" /* Protocol.Network.ChallengeEventDetailsChallengeResult.Success */:
            return i18nString(UIStrings.success);
        case "NoSessionId" /* Protocol.Network.ChallengeEventDetailsChallengeResult.NoSessionId */:
            return i18nString(UIStrings.noSessionId);
        case "NoSessionMatch" /* Protocol.Network.ChallengeEventDetailsChallengeResult.NoSessionMatch */:
            return i18nString(UIStrings.noSessionMatch);
        case "CantSetBoundCookie" /* Protocol.Network.ChallengeEventDetailsChallengeResult.CantSetBoundCookie */:
...
function deletionReasonToString(deletionReason) {
    switch (deletionReason) {
        case "Expired" /* Protocol.Network.TerminationEventDetailsDeletionReason.Expired */:
            return i18nString(UIStrings.expired);
        case "FailedToRestoreKey" /* Protocol.Network.TerminationEventDetailsDeletionReason.FailedToRestoreKey */:
            return i18nString(UIStrings.failedToRestoreKey);
        case "FailedToUnwrapKey" /* Protocol.Network.TerminationEventDetailsDeletionReason.FailedToUnwrapKey */:
            return i18nString(UIStrings.failedToUnwrapKey);
        case "StoragePartitionCleared" /* Protocol.Network.TerminationEventDetailsDeletionReason.StoragePartitionCleared */:
            return i18nString(UIStrings.storagePartitionCleared);
        case "ClearBrowsingData" /* Protocol.Network.TerminationEventDetailsDeletionReason.ClearBrowsingData */:
            return i18nString(UIStrings.clearBrowsingData);
        case "ServerRequested" /* Protocol.Network.TerminationEventDetailsDeletionReason.ServerRequested */:
            return i18nString(UIStrings.serverRequestedTermination);
        case "InvalidSessionParams" /* Protocol.Network.TerminationEventDetailsDeletionReason.InvalidSessionParams */:
            return i18nString(UIStrings.invalidSessionParams);
        case "RefreshFatalError" /* Protocol.Network.TerminationEventDetailsDeletionReason.RefreshFatalError */:
