...
const UIStrings = {
  ...
  PrefetchIneligibleRetryAfter:
      'A previous prefetch to the origin got an HTTP 503 response with a Retry-After header that hasn’t elapsed yet',
  /**
  ...
  PrefetchNotEligibleExistingProxy:
      'The URL isn’t eligible to be prefetched, because in the default network context it is configured to use a proxy server',
  /**
   * @description Description text for prefetch status PrefetchNotEligibleHostIsNonUnique.
   */
  PrefetchNotEligibleHostIsNonUnique:
      'The URL was not eligible to be prefetched because its host was not unique (e.g., a non publicly routable IP address or a hostname which isn’t registry-controlled), but the prefetch was required to be proxied',
  /**
  ...
  PrefetchNotEligibleSameSiteCrossOriginPrefetchRequiredProxy:
      'The URL was not eligible to be prefetched because the default network context can’t be configured to use the prefetch proxy for a same-site cross-origin prefetch request',
  /**
  ...
  PrefetchNotEligibleUserHasServiceWorker:
      'The URL was not eligible to be prefetched because there was a registered service worker for that origin, which isn’t currently supported',
  /**
  ...
  PrefetchEvictedAfterCandidateRemoved:
      'The prefetch was discarded because no speculation rule in the initiating page triggers a prefetch for this URL anymore',
  /**
  ...
  prerenderFinalStatusLowEndDevice:
      'The prerender was not performed because this device doesn’t have enough total system memory to support prerendering',
  /**
  ...
  prerenderFinalStatusMojoBinderPolicy:
      'The prerendered page used a forbidden JavaScript API that isn’t currently supported. (Internal Mojo interface: {PH1})',
  /**
  ...
  prerenderFinalStatusDownload:
      'The prerendered page attempted to initiate a download, which isn’t currently supported',
  /**
  ...
  prerenderFinalStatusLoginAuthRequested:
      'The prerendering navigation required HTTP authentication, which isn’t currently supported',
  /**
  ...
  prerenderFinalStatusAudioOutputDeviceRequested:
      'The prerendered page requested audio output, which isn’t currently supported',
  /**
  ...
  prerenderFinalStatusHasEffectiveUrl:
      'The initiating page can’t perform prerendering, because it has an effective URL that is different from its normal URL. (For example, the New Tab Page, or hosted apps.)',
  /**
  ...
  prerenderFinalStatusSameSiteCrossOriginRedirectNotOptInInInitialNavigation:
      'The prerendering navigation failed because the prerendered URL redirected to a cross-origin same-site URL, but the destination response didn’t include the appropriate Supports-Loading-Mode header',
  /**
  ...
  prerenderFinalStatusSameSiteCrossOriginNavigationNotOptInInInitialNavigation:
      'The prerendering navigation failed because it was to a cross-origin same-site URL, but the destination response didn’t include the appropriate Supports-Loading-Mode header',
  /**
  ...
  prerenderFinalStatusSameSiteCrossOriginRedirectNotOptInInMainFrameNavigation:
      'The prerendered page navigated to a URL which redirected to a cross-origin same-site URL, but the destination response didn’t include the appropriate Supports-Loading-Mode header',
  /**
  ...
  prerenderFinalStatusSameSiteCrossOriginNavigationNotOptInInMainFrameNavigation:
      'The prerendered page navigated to a cross-origin same-site URL, but the destination response didn’t include the appropriate Supports-Loading-Mode header',
  /**
  ...
  prerenderFinalStatusActivatedWithAuxiliaryBrowsingContexts:
      'The prerender was not used because during activation time, there were other windows with an active opener reference to the initiating page, which isn’t currently supported',
  /**
