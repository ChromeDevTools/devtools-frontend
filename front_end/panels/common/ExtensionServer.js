...
export class ExtensionServer extends Common.ObjectWrapper.ObjectWrapper {
    ...
    registerLanguageExtensionEndpoint(message, _shared_port) {
        ...
        const endpoint = new Extensions.LanguageExtensionEndpoint.LanguageExtensionEndpoint(registration.allowFileAccess, extensionOrigin, pluginName, { language, symbol_types: symbol_types_array }, port, pluginManager);
    ...
    async notifyRequestFinished(event) {
        ...
        if (!this.subscribers.has("network-request-finished" /* Extensions.ExtensionAPI.PrivateAPI.Events.NetworkRequestFinished */)) {
            return;
        }
     ...
     */
    syncExtraHeaders() {
        const allHeaders = Object.create(null);
