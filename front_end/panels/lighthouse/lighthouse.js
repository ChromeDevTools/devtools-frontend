...
((Emulation3) => {
  ...
  })(ScreenOrientationType = Emulation3.ScreenOrientationType || (Emulation3.ScreenOrientationType = {}));
  ...
  })(DisplayFeatureOrientation = Emulation3.DisplayFeatureOrientation || (Emulation3.DisplayFeatureOrientation = {}));
  let DevicePostureType;
  ((DevicePostureType2) => {
    DevicePostureType2["Continuous"] = "continuous";
    DevicePostureType2["Folded"] = "folded";
  })(DevicePostureType = Emulation3.DevicePostureType || (Emulation3.DevicePostureType = {}));
  ...
  })(VirtualTimePolicy = Emulation3.VirtualTimePolicy || (Emulation3.VirtualTimePolicy = {}));
  let SensorType;
  ((SensorType2) => {
  ...
  })(SensorType = Emulation3.SensorType || (Emulation3.SensorType = {}));
  let PressureSource;
  ((PressureSource2) => {
    PressureSource2["Cpu"] = "cpu";
  })(PressureSource = Emulation3.PressureSource || (Emulation3.PressureSource = {}));
  let PressureState;
  ((PressureState2) => {
  ...
  })(PressureState = Emulation3.PressureState || (Emulation3.PressureState = {}));
  let DisabledImageType;
  ((DisabledImageType2) => {
    DisabledImageType2["Avif"] = "avif";
    DisabledImageType2["Jxl"] = "jxl";
    DisabledImageType2["Webp"] = "webp";
  })(DisabledImageType = Emulation3.DisabledImageType || (Emulation3.DisabledImageType = {}));
  ...
  })(SetEmitTouchEventsForMouseRequestConfiguration = Emulation3.SetEmitTouchEventsForMouseRequestConfiguration || (Emulation3.SetEmitTouchEventsForMouseRequestConfiguration = {}));
  ...
  })(SetEmulatedVisionDeficiencyRequestType = Emulation3.SetEmulatedVisionDeficiencyRequestType || (Emulation3.SetEmulatedVisionDeficiencyRequestType = {}));
  ...
  })(SetCPUPerformanceOverrideRequestPerformanceTier = Emulation3.SetCPUPerformanceOverrideRequestPerformanceTier || (Emulation3.SetCPUPerformanceOverrideRequestPerformanceTier = {}));
})(Emulation || (Emulation = {}));
var Extensions;
((Extensions2) => {
  let StorageArea;
...
import * as Emulation2 from "../emulation/emulation.js";
var UIStrings = {
  /**
...
var LighthouseRun = class {
  ...
  async restoreEmulationAndProtocolConnection() {
    ...
    Emulation2.InspectedPagePlaceholder.InspectedPagePlaceholder.instance().update(true);
  ...
  async startLighthouse(overrides) {
    ...
    this.lastAction = new Promise(async (resolve) => {
      ...
      this.currentLighthouseRun = new LighthouseRun(
        ...
        categoryIDs,
        flags,
        Boolean(overrides?.isAIControlled)
      );
...
var STORAGE_TYPE_NAMES = /* @__PURE__ */ new Map([
  [Storage.StorageType.Local_storage, i18nLazyString(UIStrings.localStorage)],
  [Storage.StorageType.Indexeddb, i18nLazyString(UIStrings.indexeddb)]
]);
var presets = null;
function getPresets() {
  if (!presets) {
...
var ReportSelector = class {
  ...
  constructor(renderNewLighthouseView) {
    ...
    this.#comboBox = new UI3.Toolbar.ToolbarComboBox(
      this.handleChange.bind(this),
      i18nString2(UIStrings2.reports),
      "lighthouse-report"
    );
  ...
  setEmptyState() {
    ...
    this.newLighthouseItem = document.createElement("option");
    this.newLighthouseItem.textContent = i18nString2(UIStrings2.newReport);
...
// ../../front_end/panels/lighthouse/RadioSetting.ts
...
var StartView = class extends UI5.Widget.Widget {
  ...
  populateRuntimeSettingAsToolbarCheckbox(settingName, toolbar2) {
    ...
    const control = new UI5.Toolbar.ToolbarSettingCheckbox(
      runtimeSetting.setting,
      runtimeSetting.description(),
  ...
  populateRuntimeSettingAsToolbarDropdown(settingName, toolbar2) {
    ...
    const control = new UI5.Toolbar.ToolbarSettingComboBox(
      options,
      runtimeSetting.setting,
      runtimeSetting.title()
    );
  ...
  populateStartButton(mode) {
    ...
    if (startButtonContainer) {
      ...
      this.startButton = UI5.UIUtils.createTextButton(
        buttonLabel,
        callback,
        { variant: Buttons.Button.Variant.PRIMARY, jslogContext: "lighthouse.start" }
      );
...
var StatusView = class {
  ...
  render() {
    if (!this.dialogRoot) {
      ...
      this.dialog.setSizeBehavior(UI6.GlassPane.SizeBehavior.SET_EXACT_WIDTH_MAX_HEIGHT);
  ...
  getMessageForPhase(phase) {
    ...
    const deviceTypeSetting = getRuntimeSettings().find((item2) => item2.setting.name === "lighthouse.device-type");
    const throttleSetting = getRuntimeSettings().find((item2) => item2.setting.name === "lighthouse.throttling");
  ...
  updateFastFactIfNecessary() {
    ...
    this.commitTextChange(
      i18nString4(UIStrings4.fastFactMessageWithPlaceholder, { PH1: this.fastFactsQueued[fastFactIndex] })
    );
...
var TimespanView = class extends UI7.Dialog.Dialog {
  ...
  render() {
    ...
    this.endButton = UI7.UIUtils.createTextButton(
      i18nString5(UIStrings5.endTimespan),
      this.endTimespan.bind(this),
      { variant: Buttons3.Button.Variant.PRIMARY, jslogContext: "lighthouse.end-time-span", className: "end-timespan" }
    );
    ...
    this.setSizeBehavior(UI7.GlassPane.SizeBehavior.SET_EXACT_WIDTH_MAX_HEIGHT);
...
var LighthousePanel = class _LighthousePanel extends UI8.Panel.Panel {
  ...
  constructor(controller) {
    ...
    new UI8.DropTarget.DropTarget(
      this.contentElement,
      [UI8.DropTarget.Type.File],
      i18nString6(UIStrings6.dropLighthouseJsonHere),
      this.handleDrop.bind(this)
    );
    this.controller.addEventListener("PageAuditabilityChanged" /* PageAuditabilityChanged */, this.refreshStartAuditUI.bind(this));
    this.controller.addEventListener("PageWarningsChanged" /* PageWarningsChanged */, this.refreshWarningsUI.bind(this));
    this.controller.addEventListener("AuditProgressChanged" /* AuditProgressChanged */, this.refreshStatusUI.bind(this));
    this.renderToolbar();
  ...
  renderToolbar() {
    ...
    this.newButton.addEventListener(UI8.Toolbar.ToolbarButton.Events.CLICK, this.renderStartView.bind(this));
    ...
    this.clearButton.addEventListener(UI8.Toolbar.ToolbarButton.Events.CLICK, this.clearAll.bind(this));
    ...
    this.rightToolbar.appendToolbarItem(new UI8.Toolbar.ToolbarSettingToggle(
      this.showSettingsPaneSetting,
      "gear",
      i18nString6(UIStrings6.lighthouseSettings),
      "gear-filled"
    ));
  ...
  buildReportUI(lighthouseResult, artifacts) {
    ...
    const optionElement = new Item(
      lighthouseResult,
      () => this.renderReport(lighthouseResult, artifacts),
