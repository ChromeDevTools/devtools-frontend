...
export class BinaryResourceView extends UI.Widget.VBox {
  readonly #binaryResourceViewFactory: SourceFrame.BinaryResourceViewFactory.BinaryResourceViewFactory;
  readonly #toolbar: UI.Toolbar.Toolbar;
  readonly #binaryViewObjects: BinaryViewObject[];
  #binaryViewTypeSetting: Common.Settings.Setting<string>;
  #binaryViewTypeCombobox: UI.Toolbar.ToolbarComboBox;
  readonly #copiedText: UI.Toolbar.ToolbarText;
  #addFadeoutSettimeoutId: number|null;
  #lastView: UI.Widget.Widget|null;
...
export class BinaryViewObject {
  ...
  #createViewFn: () => UI.Widget.Widget;
  #view: UI.Widget.Widget|null;
