...
export class NetworkOverview extends PerfUI.TimelineOverviewPane.TimelineOverviewBase {
  #selectedFilmStripTime: number;
  #numBands: number;
  #updateScheduled: boolean;
  #highlightedRequest: SDK.NetworkRequest.NetworkRequest|null;
  #loadEvents!: number[];
  #domContentLoadedEvents!: number[];
  #nextBand!: number;
  #bandMap!: Map<string, number>;
  #requestsList!: SDK.NetworkRequest.NetworkRequest[];
  #requestsSet!: Set<SDK.NetworkRequest.NetworkRequest>;
  #span!: number;
  #filmStripModel?: SDK.FilmStripModel.FilmStripModel|null;
  #lastBoundary?: NetworkTimeBoundary|null;
