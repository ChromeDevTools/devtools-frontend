...
WebInspector.HeapProfileView = function(profileHeader) {
  ...
  this.profile = new WebInspector.SamplingHeapProfileModel(
...
WebInspector.SamplingHeapProfileType = function() {
  WebInspector.ProfileType.call(
      this, WebInspector.SamplingHeapProfileType.TypeId,
      WebInspector.UIString('Record Allocation Profile'));
...
WebInspector.SamplingHeapProfileType.prototype = {
  /**
     ...
     * @return {string}
     */
  typeName: function() { return 'Heap'; },

  /**
     * @override
     * @return {string}
     */
  fileExtension: function() { return '.heapprofile'; },
  ...
  get treeItemTitle() { return WebInspector.UIString('ALLOCATION PROFILES'); },

  get description() {
    return WebInspector.UIString(
        'Allocation profiles show memory allocations from your JavaScript functions.');
  },
  ...
  stopRecordingProfile: function() {
    ...
    function fireEvent() {
      this.dispatchEventToListeners(
          WebInspector.ProfileType.Events.ProfileComplete, recordedProfile);
    }
   ...
   * @override
   */
  profileBeingRecordedRemoved: function() { this.stopRecordingProfile(); },
...
WebInspector.SamplingHeapProfileHeader = function(target, type, title) {
  WebInspector.WritableProfileHeader.call(
...
WebInspector.SamplingHeapProfileHeader.prototype = {
  /**
     ...
     */
  createView: function() { return new WebInspector.HeapProfileView(this); },

  /**
     * @return {!HeapProfilerAgent.SamplingHeapProfile}
     */
  protocolProfile: function() { return this._protocolProfile; },
...
WebInspector.SamplingHeapProfileModel.prototype = {
  ...
  _translateProfileTree: function(root) {
    ...
    while (sourceNodeStack.length) {
      ...
      parentNode.children =
          sourceNode.children.map(child => new WebInspector.SamplingHeapProfileNode(child));
...
WebInspector.HeapProfileView.NodeFormatter.prototype = {
  /**
     ...
     * @return {string}
     */
  formatValue: function(value) { return Number.withThousandsSeparator(value); },
  ...
  /**
     ...
     * @return {string}
     */
  formatPercent: function(value, node) { return WebInspector.UIString('%.2f\u2009%%', value); },
...
WebInspector.HeapFlameChartDataProvider.prototype = {
  /**
     ...
     * @return {number}
     */
  minimumBoundary: function() { return 0; },

  /**
     * @override
     * @return {number}
     */
  totalTime: function() { return this._profile.root.total; },
  ...
  _calculateTimelineData: function() {
    ...
    this._timelineData = new WebInspector.FlameChart.TimelineData(
        entryLevels, entryTotalTimes, entryStartTimes, null);
  ...
  prepareHighlightedEntryInfo: function(entryIndex) {
     ...
     * @param {string} value
     */
    function pushEntryInfoRow(title, value) { entryInfo.push({title: title, value: value}); }
    pushEntryInfoRow(
        WebInspector.UIString('Name'), WebInspector.beautifyFunctionName(node.functionName));
