...
WebInspector.ClearStorageView = function(resourcesPanel) {
  ...
  this._appendItem(
      application, WebInspector.UIString('Unregister service workers'), 'service_workers');
...
WebInspector.ClearStorageView.prototype = {
  ...
  targetAdded: function(target) {
    ...
    securityOriginManager.addEventListener(
        WebInspector.SecurityOriginManager.Events.MainSecurityOriginChanged, this._originChanged,
        this);
  },
