...
WebInspector.CSSMediaQuery = function(payload) {
  ...
  for (var j = 0; j < payload.expressions.length; ++j)
    this._expressions.push(
        WebInspector.CSSMediaQueryExpression.parsePayload(payload.expressions[j]));
};
...
WebInspector.CSSMediaQuery.prototype = {
  ...
  /**
     ...
     */
  expressions: function() { return this._expressions; }
};
...
WebInspector.CSSMediaQueryExpression = function(payload) {
  ...
  this._valueRange =
      payload.valueRange ? WebInspector.TextRange.fromObject(payload.valueRange) : null;
...
WebInspector.CSSMediaQueryExpression.prototype = {
  ...
  /**
     * @return {string}
     */
  unit: function() { return this._unit; },

  /**
     * @return {string}
     */
  feature: function() { return this._feature; },

  /**
     * @return {?WebInspector.TextRange}
     */
  valueRange: function() { return this._valueRange; },

  /**
     * @return {?number}
     */
  computedLength: function() { return this._computedLength; }
};
