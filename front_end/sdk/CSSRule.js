 ...
 * @param {{style: !CSSAgent.CSSStyle, styleSheetId: (string|undefined), origin:
...
WebInspector.CSSRule.prototype = {
  ...
  /**
     * @return {boolean}
     */
  isUserAgent: function() { return this.origin === CSSAgent.StyleSheetOrigin.UserAgent; },

  /**
     * @return {boolean}
     */
  isInjected: function() { return this.origin === CSSAgent.StyleSheetOrigin.Injected; },

  /**
     * @return {boolean}
     */
  isViaInspector: function() { return this.origin === CSSAgent.StyleSheetOrigin.Inspector; },

  /**
     * @return {boolean}
     */
  isRegular: function() { return this.origin === CSSAgent.StyleSheetOrigin.Regular; }
};
...
WebInspector.CSSStyleRule = function(cssModel, payload) {
  ...
  this.media =
      payload.media ? WebInspector.CSSMedia.parseMediaArrayPayload(cssModel, payload.media) : [];
};
...
WebInspector.CSSStyleRule.prototype = {
  ...
  /**
     * @return {string}
     */
  selectorText: function() { return this.selectors.select('text').join(', '); },
  ...
  columnNumberInSource: function(selectorIndex) {
    ...
    return styleSheetHeader.columnNumberInSource(
        selector.range.startLine, selector.range.startColumn);
  },
...
WebInspector.CSSKeyframesRule = function(cssModel, payload) {
  ...
  this._keyframes = payload.keyframes.map(
      keyframeRule => new WebInspector.CSSKeyframeRule(cssModel, keyframeRule));
};
...
WebInspector.CSSKeyframesRule.prototype = {
  /**
     ...
     */
  name: function() { return this._animationName; },

  /**
     * @return {!Array.<!WebInspector.CSSKeyframeRule>}
     */
  keyframes: function() { return this._keyframes; }
};
...
WebInspector.CSSKeyframeRule.prototype = {
  /**
     * @return {!WebInspector.CSSValue}
     */
  key: function() { return this._keyText; },

  /**
   * @param {!CSSAgent.Value} payload
   */
  _reinitializeKey: function(payload) { this._keyText = new WebInspector.CSSValue(payload); },
