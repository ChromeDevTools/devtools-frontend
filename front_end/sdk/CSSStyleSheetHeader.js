...
WebInspector.CSSStyleSheetHeader.prototype = {
  ...
  originalContentProvider: function() {
    if (!this._originalContentProvider) {
      ...
      this._originalContentProvider = new WebInspector.StaticContentProvider(
  ...
  /**
     ...
     */
  target: function() { return this._cssModel.target(); },
  ...
  /**
     ...
     * @return {string}
     */
  contentURL: function() { return this.resourceURL(); },
  ...
  /**
     * @return {boolean}
     */
  isViaInspector: function() { return this.origin === 'inspector'; }
};
...
WebInspector.CSSStyleSheetHeader.OriginalContentProvider.prototype = {
  /**
     ...
     * @return {string}
     */
  contentURL: function() { return this._header.contentURL(); },

  /**
     * @override
     * @return {!WebInspector.ResourceType}
     */
  contentType: function() { return this._header.contentType(); },
  ...
  requestContent: function() {
    return /** @type {!Promise<?string>} */ (
        this._header.cssModel().originalStyleSheetText(this._header));
  },
