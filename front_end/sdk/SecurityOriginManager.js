...
WebInspector.SecurityOriginManager.fromTarget = function(target) {
  var securityOriginManager = /** @type {?WebInspector.SecurityOriginManager} */ (
...
WebInspector.SecurityOriginManager.prototype = {
  ...
  addSecurityOrigin: function(securityOrigin) {
    ...
    if (!currentCount) {
      ...
      this.dispatchEventToListeners(
          WebInspector.SecurityOriginManager.Events.SecurityOriginAdded, securityOrigin);
      return;
    }
  ...
  removeSecurityOrigin: function(securityOrigin) {
    ...
    if (currentCount === 1) {
      ...
      this.dispatchEventToListeners(
          WebInspector.SecurityOriginManager.Events.SecurityOriginRemoved, securityOrigin);
      return;
    }
    this._securityOriginCounter.set(securityOrigin, currentCount - 1);
  },
  ...
  /**
     * @return {!Array<string>}
     */
  securityOrigins: function() { return this._securityOriginCounter.keysArray(); },
  ...
  setMainSecurityOrigin: function(securityOrigin) {
    ...
    this.dispatchEventToListeners(
        WebInspector.SecurityOriginManager.Events.MainSecurityOriginChanged, securityOrigin);
  },
