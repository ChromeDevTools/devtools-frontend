...
WebInspector.Target = function(targetManager, name, capabilitiesMask, connection, parentTarget) {
  ...
  connection.addEventListener(
      InspectorBackendClass.Connection.Events.Disconnected, this._onDisconnect, this);
...
WebInspector.Target.prototype = {
  ...
  /**
     * @return {string}
     */
  name: function() { return this._name || this._inspectedURLName; },
  ...
  /**
     ...
     */
  model: function(modelClass) { return this._modelByConstructor.get(modelClass) || null; },
  ...
  setInspectedURL: function(inspectedURL) {
    ...
    if (!this._name)
      this._targetManager.dispatchEventToListeners(
          WebInspector.TargetManager.Events.NameChanged, this);
  },
...
WebInspector.SDKModel = function(modelClass, target) {
  ...
  WebInspector.targetManager.addEventListener(
      WebInspector.TargetManager.Events.TargetDisposed, this._targetDisposed, this);
};
