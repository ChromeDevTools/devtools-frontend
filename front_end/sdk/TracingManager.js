...
WebInspector.TracingManager.prototype = {
  ...
  start: function(client, categoryFilter, options, callback) {
    ...
    this._target.tracingAgent().start(
        categoryFilter, options, bufferUsageReportingIntervalMs,
        WebInspector.TracingManager.TransferMode.ReportEvents, callback);
...
WebInspector.TracingDispatcher.prototype = {
   ...
   */
  dataCollected: function(data) { this._tracingManager._eventsCollected(data); },

  /**
   * @override
   */
  tracingComplete: function() { this._tracingManager._tracingComplete(); }
};
