...
WebInspector.FrameworkBlackboxSettingsTab = function() {
  ...
  this.contentElement.createChild('div', 'header').textContent =
      WebInspector.UIString('Framework Blackbox Patterns');
  this.contentElement.createChild('div', 'blackbox-content-scripts')
      .appendChild(WebInspector.SettingsUI.createSettingCheckbox(
          WebInspector.UIString('Blackbox content scripts'),
          WebInspector.moduleSetting('skipContentScripts'), true));
  ...
  var addPatternButton = createTextButton(
      WebInspector.UIString('Add pattern...'), this._addButtonClicked.bind(this), 'add-button');
...
WebInspector.FrameworkBlackboxSettingsTab.prototype = {
  ...
  _createEditor: function() {
    ...
    fields.createChild('div', 'blackbox-pattern')
        .appendChild(
            editor.createInput('pattern', 'text', '/framework\\.js$', patternValidator.bind(this)));
    fields.createChild('div', 'blackbox-separator blackbox-separator-invisible');
    fields.createChild('div', 'blackbox-behavior')
        .appendChild(editor.createSelect(
            'behavior', [this._blackboxLabel, this._disabledLabel], behaviorValidator));
    ...
    /**
         ...
         * @return {boolean}
         */
    function behaviorValidator(item, index, input) { return true; }
  },
