...
WebInspector.FileBasedSearchResultsPane.FileTreeElement.prototype = {
  ...
  onattach: function() { this._updateSearchMatches(); },
  ...
  _appendSearchMatches: function(fromIndex, toIndex) {
    ...
    for (var i = 0; i < queries.length; ++i)
      regexes.push(createSearchRegex(
  ...
  _appendShowMoreMatchesElement: function(startMatchIndex) {
    ...
    var showMoreMatchesText =
        WebInspector.UIString('Show all matches (%d more).', matchesLeftCount);
    ...
    this._showMoreMatchesTreeElement.onselect =
        this._showMoreMatchesElementSelected.bind(this, startMatchIndex);
  },
