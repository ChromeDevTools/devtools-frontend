...
WebInspector.JavaScriptOutlineDialog.show = function(uiSourceCode, selectItemCallback) {
  ...
  new WebInspector.FilteredListWidget(WebInspector.JavaScriptOutlineDialog._instanceForTests)
      .showAsDialog();
};
...
/**
 * @typedef {{isLastChunk: boolean, chunk: !Array.<!{selectorText: string, lineNumber: number,
 * columnNumber: number}>}}
 */
