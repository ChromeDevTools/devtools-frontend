...
WebInspector.ObjectEventListenersSidebarPane.prototype = {
  /**
     ...
     */
  toolbarItems: function() { return [this._refreshButton]; },
  ...
  willHide: function() {
    ...
    WebInspector.context.removeFlavorChangeListener(
        WebInspector.ExecutionContext, this.update, this);
    this._refreshButton.setEnabled(false);
  },
  ...
  _windowObjectInContext: function(executionContext) {
    ...
    function windowObjectInContext(fulfill, reject) {
      executionContext.evaluate(
          'self', WebInspector.ObjectEventListenersSidebarPane._objectGroupName, false, true, false,
          false, false, mycallback);
      /**
