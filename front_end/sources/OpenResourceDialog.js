...
WebInspector.OpenResourceDialog.prototype = {
  ...
  /**
     ...
     * @return {boolean}
     */
  filterProject: function(project) { return !WebInspector.Project.isServiceProject(project); },
...
WebInspector.SelectUISourceCodeForProjectTypesDialog.prototype = {
  ...
  /**
     ...
     * @return {boolean}
     */
  filterProject: function(project) { return this._types.indexOf(project.type()) !== -1; },
