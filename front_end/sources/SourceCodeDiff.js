...
WebInspector.SourceCodeDiff.prototype = {
  updateDiffMarkersWhenPossible: function() {
    ...
    this._updateTimeout = setTimeout(
        this.updateDiffMarkersImmediately.bind(this), WebInspector.SourceCodeDiff.UpdateTimeout);
  },
  ...
  /**
   * @param {!Map<number, !{lineNumber: number, type:
   * !WebInspector.SourceCodeDiff.GutterDecorationType}>} decorations
   */
...
WebInspector.SourceCodeDiff.GutterDecoration.prototype = {
  ...
  install: function() {
    ...
    this._textEditor.setGutterDecoration(
        location.lineNumber, WebInspector.SourceCodeDiff.DiffGutterType, element);
  ...
  remove: function() {
    ...
    if (!location)
      return;
    this._textEditor.setGutterDecoration(
        location.lineNumber, WebInspector.SourceCodeDiff.DiffGutterType, null);
