...
WebInspector.SourcesView = function() {
  ...
  this._editorContainer = new WebInspector.TabbedEditorContainer(
      this, WebInspector.settings.createLocalSetting('previouslyViewedFiles', []),
  ...
  this._historyManager =
      new WebInspector.EditingLocationHistoryManager(this, this.currentSourceFrame.bind(this));
  ...
  function handleBeforeUnload(event) {
    ...
    event.returnValue =
        WebInspector.UIString('DevTools have unsaved changes that will be permanently lost.');
...
WebInspector.SourcesView.prototype = {
  ...
  registerShortcuts: function(registerShortcutDelegate) {
    ...
    registerShortcut.call(
        this, WebInspector.ShortcutsScreen.SourcesPanelShortcuts.ToggleBreakpoint,
        this._toggleBreakpoint.bind(this));
    registerShortcut.call(
        this, WebInspector.ShortcutsScreen.SourcesPanelShortcuts.Save, this._save.bind(this));
    registerShortcut.call(
        this, WebInspector.ShortcutsScreen.SourcesPanelShortcuts.SaveAll, this._saveAll.bind(this));
  },
  ...
  /**
     ...
     */
  currentUISourceCode: function() { return this._editorContainer.currentFile(); },
  ...
  _createSourceView: function(uiSourceCode) {
    ...
    if (contentType.hasScripts())
      ...
      sourceView = new WebInspector.ImageView(
          WebInspector.NetworkProject.uiSourceCodeMimeType(uiSourceCode), uiSourceCode);
  ...
  /**
     ...
     * @return {!WebInspector.Widget}
     */
  viewForFile: function(uiSourceCode) { return this._getOrCreateSourceView(uiSourceCode); },
  ...
  _editorSelected: function(event) {
    var previousSourceFrame = event.data.previousView instanceof WebInspector.UISourceCodeFrame ?
        event.data.previousView :
        null;
    if (previousSourceFrame)
      previousSourceFrame.setSearchableView(null);
    var currentSourceFrame = event.data.currentView instanceof WebInspector.UISourceCodeFrame ?
    ...
    this.dispatchEventToListeners(
        WebInspector.SourcesView.Events.EditorSelected, this._editorContainer.currentFile());
  },
...
WebInspector.SourcesView.SwitchFileActionDelegate.prototype = {
  ...
  handleAction: function(context, actionId) {
    ...
    var nextUISourceCode =
        WebInspector.SourcesView.SwitchFileActionDelegate._nextFile(currentUISourceCode);
    if (!nextUISourceCode)
      return false;
