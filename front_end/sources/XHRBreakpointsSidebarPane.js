...
WebInspector.XHRBreakpointsSidebarPane = function() {
  ...
  this._addButton =
      new WebInspector.ToolbarButton(WebInspector.UIString('Add breakpoint'), 'add-toolbar-item');
...
WebInspector.XHRBreakpointsSidebarPane.prototype = {
  ...
  _emptyElementContextMenu: function(event) {
    ...
    contextMenu.appendItem(
        WebInspector.UIString.capitalize('Add ^breakpoint'), this._addButtonClicked.bind(this));
    contextMenu.show();
  },
  ...
  _addButtonClicked: function(event) {
    ...
    this.addListElement(
        inputElementContainer, /** @type {?Element} */ (this.listElement.firstChild));
  ...
  _setBreakpoint: function(url, enabled, target) {
    ...
    var title =
        url ? WebInspector.UIString('URL contains "%s"', url) : WebInspector.UIString('Any XHR');
  ...
  _contextMenu: function(url, event) {
    ...
    contextMenu.appendItem(
        WebInspector.UIString.capitalize('Add ^breakpoint'), this._addButtonClicked.bind(this));
    contextMenu.appendItem(
        WebInspector.UIString.capitalize('Remove ^breakpoint'), removeBreakpoint.bind(this));
  ...
  _labelClicked: function(url) {
    ...
    WebInspector.InplaceEditor.startEditing(
        inputElement, new WebInspector.InplaceEditor.Config(
                          finishEditing.bind(this, true), finishEditing.bind(this, false)));
  },
  ...
  _saveBreakpoints: function() {
    ...
    for (var url of this._breakpointElements.keys())
      breakpoints.push(
          {url: url, enabled: this._breakpointElements.get(url)._checkboxElement.checked});
