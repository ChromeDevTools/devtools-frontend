...
export class MockExecutionContext extends SDK.RuntimeModel.ExecutionContext {
  ...
  override async evaluateWithSelectedFrameFallback(_options: SDK.RuntimeModel.EvaluationOptions, userGesture: boolean,
                                                   _awaitPromise: boolean): Promise<SDK.RuntimeModel.EvaluationResult> {
