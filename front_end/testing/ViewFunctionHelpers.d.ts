...
type ViewFunctionLike = ((input: any, output: any, target: HTMLElement) => void) | ((input: any, output: any, target: DocumentFragment) => void);
...
interface ViewStubExtensions<WidgetConstructorT extends WidgetConstructor> extends sinon.SinonSpy<[
    ViewInput<WidgetConstructorT>,
    ViewOutput<WidgetConstructorT>,
