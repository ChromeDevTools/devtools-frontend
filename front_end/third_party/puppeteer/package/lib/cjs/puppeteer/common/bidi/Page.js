...
class Page extends Page_js_1.Page {
    constructor(browserContext, info) {
        ...
        __classPrivateFieldSet(this, _Page_accessibility, new Accessibility_js_1.Accessibility({
            describeNode: (id) => {
        ...
        __classPrivateFieldSet(this, _Page_tracing, new Tracing_js_1.Tracing({
            read: opts => {
