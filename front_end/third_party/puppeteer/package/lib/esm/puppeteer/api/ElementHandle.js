...
let ElementHandle = (() => {
    ...
    return class ElementHandle extends _classSuper {
        static {
            ...
            _isIntersectingViewport_decorators = [throwIfDisposed(), (_5 = ElementHandle).bindIsolatedHandle.bind(_5)];
            _scrollIntoView_decorators = [throwIfDisposed(), (_6 = ElementHandle).bindIsolatedHandle.bind(_6)];
