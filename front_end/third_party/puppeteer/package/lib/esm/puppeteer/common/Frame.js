...
export class Frame extends BaseFrame {
    ...
    async addScriptTag(options) {
        ...
        return this.worlds[MAIN_WORLD].transferHandle(await this.worlds[PUPPETEER_WORLD].evaluateHandle(async ({ Deferred }, { url, id, type, content }) => {
    ...
    async addStyleTag(options) {
        ...
        return this.worlds[MAIN_WORLD].transferHandle(await this.worlds[PUPPETEER_WORLD].evaluateHandle(async ({ Deferred }, { url, content }) => {
            const deferred = Deferred.create();
            let element;
            if (!url) {
