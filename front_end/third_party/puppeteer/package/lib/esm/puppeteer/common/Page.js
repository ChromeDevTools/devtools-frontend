...
export class CDPPage extends Page {
    ...
    constructor(client, target, ignoreHTTPSErrors, screenshotTaskQueue) {
        ...
        __classPrivateFieldSet(this, _CDPPage_accessibility, new Accessibility({
            describeNode(id) {
        ...
        __classPrivateFieldSet(this, _CDPPage_tracing, new Tracing({
            read: opts => {
                return __classPrivateFieldGet(this, _CDPPage_client, "f").send('IO.read', opts);
            },
            close: opts => {
                return __classPrivateFieldGet(this, _CDPPage_client, "f").send('IO.close', opts);
            },
            start: opts => {
            ...
            stop: async () => {
                ...
                __classPrivateFieldGet(this, _CDPPage_client, "f").once('Tracing.tracingComplete', event => {
                    deferred.resolve(event);
                });
                await __classPrivateFieldGet(this, _CDPPage_client, "f").send('Tracing.end');
