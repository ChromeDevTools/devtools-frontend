...
export class JSHandle extends BaseJSHandle {
    ...
    async jsonValue() {
        if (!('handle' in __classPrivateFieldGet(this, _JSHandle_remoteValue, "f"))) {
            return BidiSerializer.deserialize(__classPrivateFieldGet(this, _JSHandle_remoteValue, "f"));
        }
    ...
    async dispose() {
        ...
        if ('handle' in __classPrivateFieldGet(this, _JSHandle_remoteValue, "f")) {
            await releaseReference(this.connecton, __classPrivateFieldGet(this, _JSHandle_remoteValue, "f"));
        }
    }
    toString() {
        if (!('handle' in __classPrivateFieldGet(this, _JSHandle_remoteValue, "f"))) {
