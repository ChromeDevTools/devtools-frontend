...
export class Emitter {
    ...
    writeStateAndResult(state, result) {
        switch (state) {
            case 1 /* BEGIN_WASM */:
    ...
    writeBeginSectionRawData(section) {
        this.ensureState(EmitterState.Wasm);
        this.writeVarUint(section.id);
    ...
    writeBeginFunctionBody(functionInfo) {
