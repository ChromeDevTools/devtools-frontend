...
export declare const enum OperatorCode {
    ...
    prefix_0xfd = 253,
    prefix_0xfe = 254,
    i32_trunc_s_sat_f32 = 64512,
    i32_trunc_u_sat_f32 = 64513,
    i32_trunc_s_sat_f64 = 64514,
    i32_trunc_u_sat_f64 = 64515,
    i64_trunc_s_sat_f32 = 64516,
    i64_trunc_u_sat_f32 = 64517,
    i64_trunc_s_sat_f64 = 64518,
    i64_trunc_u_sat_f64 = 64519,
    memory_init = 64520,
    data_drop = 64521,
    memory_copy = 64522,
    memory_fill = 64523,
    ...
    i32_atomic_rmw8_u_add = 65056,
    i32_atomic_rmw16_u_add = 65057,
    i64_atomic_rmw8_u_add = 65058,
    i64_atomic_rmw16_u_add = 65059,
    i64_atomic_rmw32_u_add = 65060,
    i32_atomic_rmw_sub = 65061,
    i64_atomic_rmw_sub = 65062,
    i32_atomic_rmw8_u_sub = 65063,
    i32_atomic_rmw16_u_sub = 65064,
    i64_atomic_rmw8_u_sub = 65065,
    i64_atomic_rmw16_u_sub = 65066,
    i64_atomic_rmw32_u_sub = 65067,
    i32_atomic_rmw_and = 65068,
    i64_atomic_rmw_and = 65069,
    i32_atomic_rmw8_u_and = 65070,
    i32_atomic_rmw16_u_and = 65071,
    i64_atomic_rmw8_u_and = 65072,
    i64_atomic_rmw16_u_and = 65073,
    i64_atomic_rmw32_u_and = 65074,
    i32_atomic_rmw_or = 65075,
    i64_atomic_rmw_or = 65076,
    i32_atomic_rmw8_u_or = 65077,
    i32_atomic_rmw16_u_or = 65078,
    i64_atomic_rmw8_u_or = 65079,
    i64_atomic_rmw16_u_or = 65080,
    i64_atomic_rmw32_u_or = 65081,
    i32_atomic_rmw_xor = 65082,
    i64_atomic_rmw_xor = 65083,
    i32_atomic_rmw8_u_xor = 65084,
    i32_atomic_rmw16_u_xor = 65085,
    i64_atomic_rmw8_u_xor = 65086,
    i64_atomic_rmw16_u_xor = 65087,
    i64_atomic_rmw32_u_xor = 65088,
    i32_atomic_rmw_xchg = 65089,
    i64_atomic_rmw_xchg = 65090,
    i32_atomic_rmw8_u_xchg = 65091,
    i32_atomic_rmw16_u_xchg = 65092,
    i64_atomic_rmw8_u_xchg = 65093,
    i64_atomic_rmw16_u_xchg = 65094,
    i64_atomic_rmw32_u_xchg = 65095,
    i32_atomic_rmw_cmpxchg = 65096,
    i64_atomic_rmw_cmpxchg = 65097,
    i32_atomic_rmw8_u_cmpxchg = 65098,
    i32_atomic_rmw16_u_cmpxchg = 65099,
    i64_atomic_rmw8_u_cmpxchg = 65100,
    i64_atomic_rmw16_u_cmpxchg = 65101,
    i64_atomic_rmw32_u_cmpxchg = 65102,
    v128_load = 64768,
