...
const roundIcons = [
  {iconName: testIcon},
  {iconName: fileIcon, iconWidth: '16px', iconHeight: '16px'},
  {iconName: plusIcon},
  {iconName: minusIcon},
  {iconName: trashBinIcon, iconWidth: '10px', iconHeight: '14px'},
  {iconName: closeIcon, iconWidth: '10px', iconHeight: '10px'},
];
...
const tinyRoundIcons = [
  {iconName: plusIcon},
  {iconName: minusIcon},
  {iconName: closeIcon, iconWidth: '9px', iconHeight: '9px'},
];
