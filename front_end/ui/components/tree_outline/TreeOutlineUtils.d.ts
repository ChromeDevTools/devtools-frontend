...
export declare const trackDOMNodeToTreeNode: <TreeNodeDataType>(weakmap: WeakMap<HTMLLIElement, TreeNode<TreeNodeDataType>>, treeNode: TreeNode<TreeNodeDataType>) => Lit.DirectiveResult<typeof TrackDOMNodeToTreeNode>;
