...
const spriteSheets = new Map<string, SpriteSheet>([
  ...
  ['match-whole-word', {cellWidth: 20, cellHeight: 20, padding: 0}],
  ['mop', {cellWidth: 20, cellHeight: 20, padding: 0}],
...
const initialDescriptors = new Map<string, Descriptor>([
  ...
  ['match-whole-word', {position: 'a1', spritesheet: 'match-whole-word', isMask: true}],
  ['mop', {position: 'a1', spritesheet: 'mop', isMask: true}],
