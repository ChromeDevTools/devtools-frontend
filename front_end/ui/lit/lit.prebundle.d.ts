...
export { AsyncDirective, Decorators, Directive, Directives, LitElement, noChange, nothing, type PropertyValues, render, StaticHtml, svg, type TemplateResult, } from '../../third_party/lit/lit.js';
