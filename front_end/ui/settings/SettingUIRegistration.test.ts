...
describe('SettingUIRegistration', () => {
  ...
  it('resolves a registered setting UI descriptor to a SettingUI instance with accessors', () => {
    ...
    assert.strictEqual(resolved.category, Common.SettingRegistration.SettingCategory.GLOBAL);
    ...
    assert.deepEqual(resolved.options,
                     [{value: 'val1', title: i18n.i18n.lockedString('Option 1'), text: undefined, raw: undefined}]);
