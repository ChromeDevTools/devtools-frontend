...
function map(ast, selector, nodeTransformer, options) {
    ...
    // but with a noop?
    var matches = (0, query_1.query)(ast, selector, options);
    var transformer = createTransformer(matches, nodeTransformer);
    var transformed = (0, typescript_1.transform)(ast, [transformer]).transformed[0];
    return transformed;
}
exports.map = map;
            ...
            function visit(node) {
                if (results.includes(node)) {
                    ...
                    return replacement !== node
                        ? replacement
                        : (0, typescript_1.visitEachChild)(node, visit, context);
                }
                return (0, typescript_1.visitEachChild)(node, visit, context);
            }
            return (0, typescript_1.visitNode)(rootNode, visit);
        };
    };
}
