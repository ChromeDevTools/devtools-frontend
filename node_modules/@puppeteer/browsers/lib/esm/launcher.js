...
var _Process_instances, _Process_executablePath, _Process_args, _Process_browserProcess, _Process_exited, _Process_browserProcessExiting, _Process_configureStdio, _Process_clearListeners, _Process_onDriverProcessExit, _Process_onDriverProcessSignal;
...
class Process {
    constructor(opts) {
        ...
        (_g = opts.detached) !== null && _g !== void 0 ? _g : (opts.detached = true);
        ...
        __classPrivateFieldSet(this, _Process_browserProcessExiting, new Promise(resolve => {
            __classPrivateFieldGet(this, _Process_browserProcess, "f").once('exit', () => {
        ...
        if (__classPrivateFieldGet(this, _Process_browserProcess, "f") &&
            ...
            try {
                if (process.platform === 'win32') {
                    childProcess.exec(`taskkill /pid ${__classPrivateFieldGet(this, _Process_browserProcess, "f").pid} /T /F`, error => {
                        if (error) {
...
_Process_executablePath = new WeakMap(), _Process_args = new WeakMap(), _Process_browserProcess = new WeakMap(), _Process_exited = new WeakMap(), _Process_browserProcessExiting = new WeakMap(), _Process_onDriverProcessExit = new WeakMap(), _Process_onDriverProcessSignal = new WeakMap(), _Process_instances = new WeakSet(), _Process_configureStdio = function _Process_configureStdio(opts) {
    if (opts.pipe) {
        if (opts.dumpio) {
