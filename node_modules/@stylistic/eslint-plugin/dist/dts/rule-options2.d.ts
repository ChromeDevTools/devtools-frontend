...
type ArrayElementNewlineSchema0 = [] | [BasicConfig$1 | {
  ArrayExpression?: BasicConfig$1;
  ArrayPattern?: BasicConfig$1;
}];
type BasicConfig$1 = ('always' | 'never' | 'consistent') | {
  consistent?: boolean;
  multiline?: boolean;
  minItems?: number | null;
};
...
type JsxCurlySpacingSchema0 = [] | [(BasicConfig & {
