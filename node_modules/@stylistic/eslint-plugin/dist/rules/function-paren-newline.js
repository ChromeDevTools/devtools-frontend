...
var function_paren_newline_default;
var init_function_paren_newline = __esmMin(() => {
	init_ast();
	init_create_rule();
	function_paren_newline_default = createRule({
...
export { function_paren_newline_default, init_function_paren_newline };
