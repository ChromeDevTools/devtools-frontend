import { AST_NODE_TYPES, STATEMENT_LIST_PARENTS, ast_exports, createGlobalLinebreakMatcher, createRule, getCommentsBetween, isEqToken, isQuestionToken, isSingleLine, skipChainExpression, warnDeprecatedOptions } from "../utils.js";
	...
	create(context, optionsWithDefaults) {
		...
		const baseOffsetListeners = {
			...
			JSXText(node) {
				...
				const indent = getNodeIndent(node.parent) + indentSize;
