...
import { ast_exports, createRule, init_ast, init_create_rule, init_jsx, isJSX, isWhiteSpaces } from "../utils.js";
var OPTION_ALWAYS, OPTION_NEVER, OPTION_IGNORE, OPTION_VALUES, DEFAULT_CONFIG, messages, jsx_curly_brace_presence_default;
var init_jsx_curly_brace_presence = __esmMin(() => {
	init_ast();
	init_jsx();
	init_create_rule();
	...
	jsx_curly_brace_presence_default = createRule({
...
export { init_jsx_curly_brace_presence, jsx_curly_brace_presence_default };
