...
var messages, jsx_indent_props_default;
var init_jsx_indent_props = __esmMin(() => {
	init_ast();
	init_create_rule();
	messages = { wrongIndent: "Expected indentation of {{needed}} {{type}} {{characters}} but found {{gotten}}." };
	jsx_indent_props_default = createRule({
...
export { init_jsx_indent_props, jsx_indent_props_default };
