...
import { createRule, init_ast, init_create_rule, isWhiteSpaces } from "../utils.js";
var optionDefaults, messages, jsx_one_expression_per_line_default;
var init_jsx_one_expression_per_line = __esmMin(() => {
	init_ast();
	init_create_rule();
	optionDefaults = { allow: "none" };
	messages = { moveToNewLine: "`{{descriptor}}` must be placed on a new line" };
	jsx_one_expression_per_line_default = createRule({
...
export { init_jsx_one_expression_per_line, jsx_one_expression_per_line_default };
