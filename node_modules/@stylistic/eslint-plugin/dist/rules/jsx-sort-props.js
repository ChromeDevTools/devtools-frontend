...
import { createRule, getPropName, init_ast, init_create_rule, init_jsx, isDOMComponent, isSingleLine } from "../utils.js";
...
var messages, RESERVED_PROPS_LIST, attributeMap, reportedNodeAttributes, jsx_sort_props_default;
var init_jsx_sort_props = __esmMin(() => {
	init_ast();
	init_jsx();
	init_create_rule();
	messages = {
	...
	reportedNodeAttributes = /* @__PURE__ */ new WeakMap();
	jsx_sort_props_default = createRule({
		name: "jsx-sort-props",
		meta: {
			type: "layout",
...
export { init_jsx_sort_props, jsx_sort_props_default };
