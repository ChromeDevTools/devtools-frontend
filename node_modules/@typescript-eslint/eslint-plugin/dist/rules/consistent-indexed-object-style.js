...
function findParentDeclaration(node) {
    if (node.parent && node.parent.type !== experimental_utils_1.AST_NODE_TYPES.TSTypeAnnotation) {
        if (node.parent.type === experimental_utils_1.AST_NODE_TYPES.TSTypeAliasDeclaration) {
            return node.parent;
        }
