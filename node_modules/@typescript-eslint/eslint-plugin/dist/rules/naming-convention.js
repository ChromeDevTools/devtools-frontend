...
function createValidator(type, context, allConfigs) {
    ...
    return (node, modifiers = new Set()) => {
        ...
        for (const config of configs) {
            if ((_a = config.filter) === null || _a === void 0 ? void 0 : _a.test(originalName)) {
...
function normalizeOption(option) {
    ...
    return {
        ...
        trailingUnderscore: option.trailingUnderscore !== undefined
            ...
            : null,
        prefix: (_c = option.prefix, (_c !== null && _c !== void 0 ? _c : null)),
        suffix: (_d = option.suffix, (_d !== null && _d !== void 0 ? _d : null)),
        // selector options
        selector: isMetaSelector(option.selector)
            ? MetaSelectors[option.selector]
            : Selectors[option.selector],
        modifiers: (_f = (_e = option.modifiers) === null || _e === void 0 ? void 0 : _e.map(m => Modifiers[m]), (_f !== null && _f !== void 0 ? _f : null)),
        types: (_h = (_g = option.types) === null || _g === void 0 ? void 0 : _g.map(m => TypeModifiers[m]), (_h !== null && _h !== void 0 ? _h : null)),
