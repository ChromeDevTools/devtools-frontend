...
exports.default = util.createRule({
    ...
    create(context) {
         ...
         * @param node The node to report
         */
        function checkForTypeAliasAssignmentSpace(node) {
            const leftNode = sourceCode.getTokenByRangeStart(node.id.range[0]);
            const rightNode = sourceCode.getTokenByRangeStart(node.typeAnnotation.range[0]);
            checkAndReportAssignmentSpace(node, leftNode, rightNode);
        }
        return Object.assign(Object.assign({}, rules), { TSEnumMember: checkForEnumAssignmentSpace, ClassProperty: checkForClassPropertyAssignmentSpace, TSTypeAliasDeclaration: checkForTypeAliasAssignmentSpace });
    },
});
