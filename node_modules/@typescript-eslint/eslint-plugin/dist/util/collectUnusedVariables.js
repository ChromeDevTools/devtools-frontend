...
class UnusedVarsVisitor extends Visitor_1.Visitor {
    ...
    constructor(context) {
        ...
        __classPrivateFieldSet(this, _UnusedVarsVisitor_scopeManager, experimental_utils_1.ESLintUtils.nullThrows(context.getSourceCode().scopeManager, 'Missing required scope manager'), "f");
    }
