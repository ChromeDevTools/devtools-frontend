...
export type AtLeastVersionConstraint = `${number}.${number}.${number}` | `${number}.${number}.${number}-${string}` | `${number}.${number}` | `${number}`;
...
//# sourceMappingURL=DependencyConstraint.d.ts.map