...
var _jsxPragma, _jsxFragmentName, _hasReferencedJsxFactory, _hasReferencedJsxFragmentFactory, _lib, _emitDecoratorMetadata;
...
class Referencer extends Visitor_1.Visitor {
    constructor(options, scopeManager) {
        ...
        __classPrivateFieldSet(this, _emitDecoratorMetadata, options.emitDecoratorMetadata);
    }
    ...
    ///////////////////
    visitClass(node) {
        ClassVisitor_1.ClassVisitor.visit(this, node, __classPrivateFieldGet(this, _emitDecoratorMetadata));
    }
    visitForIn(node) {
...
_jsxPragma = new WeakMap(), _jsxFragmentName = new WeakMap(), _hasReferencedJsxFactory = new WeakMap(), _hasReferencedJsxFragmentFactory = new WeakMap(), _lib = new WeakMap(), _emitDecoratorMetadata = new WeakMap();
