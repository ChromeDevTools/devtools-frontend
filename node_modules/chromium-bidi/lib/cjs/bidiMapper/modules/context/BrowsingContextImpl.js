...
class BrowsingContextImpl {
    ...
    dispose(emitContextDestroyed) {
        this.#pendingCommandNavigation?.reject(new protocol_js_1.UnknownErrorException('navigation canceled by context disposal'));
    ...
    #initListeners() {
        ...
        this.#cdpTarget.cdpClient.on('Page.frameStartedLoading', (params) => {
            ...
            this.#navigationId = this.#pendingNavigationId ?? (0, uuid_js_1.uuidv4)();
    ...
    async navigate(url, wait) {
        ...
        this.#pendingCommandNavigation?.reject(new protocol_js_1.UnknownErrorException('navigation canceled by concurrent navigation'));
        ...
        this.#pendingCommandNavigation = new Deferred_js_1.Deferred();
