...
export declare class SessionProcessor {
    ...
    subscribe(params: Session.SubscriptionRequest, channel?: BidiPlusChannel): Promise<Session.SubscribeResult>;
    unsubscribe(params: Session.UnsubscribeParameters, channel?: BidiPlusChannel): Promise<EmptyResult>;
}
