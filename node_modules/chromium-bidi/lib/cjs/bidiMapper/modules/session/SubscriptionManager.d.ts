...
export declare class SubscriptionManager {
    ...
    getChannelsSubscribedToEvent(eventName: ChromiumBidi.EventNames, contextId: BrowsingContext.BrowsingContext): BidiPlusChannel[];
    getChannelsSubscribedToEventGlobally(eventName: ChromiumBidi.EventNames): BidiPlusChannel[];
     ...
     */
    subscribe(eventNames: ChromiumBidi.EventNames[], contextIds: BrowsingContext.BrowsingContext[], userContextIds: Browser.UserContext[], channel: BidiPlusChannel): Subscription;
    /**
     * Unsubscribes atomically from all events in the given contexts and channel.
     *
     * This is a legacy spec branch to unsubscribe by attributes.
     */
    unsubscribe(inputEventNames: ChromiumBidi.EventNames[], inputContextIds: BrowsingContext.BrowsingContext[], channel: BidiPlusChannel): void;
    /**
