...
const rule = {
	...
	create(context) {
		...
		return { Program() {
			...
			const knownProps = props.filter((prop) => orderMap.has(getKeyName(prop))).sort((a, b) => orderMap.get(getKeyName(a)) - orderMap.get(getKeyName(b)));
...
//#endregion
export { meta_property_ordering_default as default };