...
//#region lib/rules/test-case-shorthand-strings.ts
const rule = {
	meta: {
		type: "suggestion",
		docs: {
		...
		messages: { useShorthand: "Use {{preferred}} for this test case instead of {{actual}}." }
	},
	create(context) {
...
//#endregion
export { test_case_shorthand_strings_default as default };