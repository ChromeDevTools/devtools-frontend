...
type Split<Input extends string, Delemiter extends string, Acc extends string[] = []> = Input extends `${infer Prefix}${Delemiter}${infer Suffix}` ? Split<Suffix, Delemiter, [...Acc, Prefix]> : [...Acc, Input];
export {};
