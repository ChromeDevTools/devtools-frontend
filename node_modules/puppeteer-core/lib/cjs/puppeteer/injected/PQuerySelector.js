...
var _PQueryEngine_instances, _PQueryEngine_input, _PQueryEngine_complexSelector, _PQueryEngine_compoundSelector, _PQueryEngine_selector, _PQueryEngine_next;
...
const pQuerySelectorAll = async function* (root, selector) {
    let selectors;
    try {
        selectors = (0, PSelectorParser_js_1.parsePSelectors)(selector);
    }
    catch (error) {
