...
export const Events={SidebarPaneAdded:Symbol('SidebarPaneAdded'),TraceProviderAdded:Symbol('TraceProviderAdded')};export class ExtensionServerPanelView extends UI.SimpleView{constructor(name,title,panel){super(title);this._name=name;this._panel=panel;}
...
self.Extensions=self.Extensions||{};Extensions=Extensions||{};Extensions.ExtensionServer=ExtensionServer;Extensions.ExtensionServer.Events=Events;Extensions.ExtensionServerPanelView=ExtensionServerPanelView;Extensions.ExtensionStatus=ExtensionStatus;Extensions.ExtensionStatus.Record;Extensions.extensionServer;