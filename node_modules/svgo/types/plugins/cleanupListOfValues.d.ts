 ...
 */
export declare const name = "cleanupListOfValues";
export declare const description = "rounds list of values to the fixed precision";
/**
 ...
 * @since 0.5.1
 */
export declare const fn: import('../lib/types.js').Plugin<CleanupListOfValuesParams>;
