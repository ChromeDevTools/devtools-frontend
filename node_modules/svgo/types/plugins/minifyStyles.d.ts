 ...
 */
export declare const name = "minifyStyles";
export declare const description = "minifies styles and removes unused styles";
/**
 ...
 * @since 0.6.0
 */
export declare const fn: import('../lib/types.js').Plugin<MinifyStylesParams>;
