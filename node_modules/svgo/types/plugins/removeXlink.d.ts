 ...
 *   removed in SVG 2. Set to true to force performing operations on those too.
 */
export declare const name = "removeXlink";
export declare const description = "remove xlink namespace and replaces attributes with the SVG 2 equivalent where applicable";
/**
 ...
 * @since 3.0.4
 */
export declare const fn: import('../lib/types.js').Plugin<RemoveXlinkParams>;
