 ...
 *      │   └── verification_stderr.log - Diagnostic verification error/stderr log (archived in CNS)
...
export const TaskOutputFile = {
  ...
  VERIFICATION_STDERR: 'verification/verification_stderr.log',
} as const;
