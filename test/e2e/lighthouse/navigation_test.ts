...
describe('Navigation', async function() {
  ...
  for (const mode of modes) {
    describe(`in ${mode} mode`, () => {
      if (mode === 'legacy') {
        // Flakey after the LH 10 roll. Adding here because the test is generated by the above for loop, so this is the easiest way to represent that this particular test is skipped.
        it.skip('[crbug.com/1414725] successfully returns a LH report in legacy mode', () => {});
        return;
      }
