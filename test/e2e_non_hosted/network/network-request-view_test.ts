    ...
    const expectedHeadersContent = [
      {
        ...
        rows: [
          'Request URL',
          'https://localhost:%/test/e2e_non_hosted/resources/network/image.svg?id=42&param=a%20b',
          'Request Method',
          'POST',
          'Status Code',
          '200 OK',
      ...
      },
      {
        ...
        rows: [
          ...
          'https://localhost:%',
          'referer',
          'https://localhost:%/test/e2e_non_hosted/resources/network/headers-and-payload.html',
          'sec-ch-ua',
          '%',
          'sec-ch-ua-mobile',
          '?0',
